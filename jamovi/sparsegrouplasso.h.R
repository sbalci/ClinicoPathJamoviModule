...
sparsegrouplassoOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            private$..data <- jmvcore::OptionData$new("data", data, NULL)
            private$..time_var <- jmvcore::OptionVariable$new("time_var", time_var, suggested=list("continuous"), permitted=list("continuous"))
            private$..event_var <- jmvcore::OptionVariable$new("event_var", event_var, suggested=list("nominal"), permitted=list("nominal", "continuous"))
            private$..pred_vars <- jmvcore::OptionVariables$new("pred_vars", pred_vars, suggested=list("continuous", "nominal"), permitted=list("continuous", "nominal"))
            private$..group_definition <- jmvcore::OptionList$new("group_definition", group_definition, options=list("factor_based", "custom", "pathway_based", "variable_type", "correlation_based"), default="factor_based")
            private$..custom_groups <- jmvcore::OptionString$new("custom_groups", custom_groups, default="")
            private$..pathway_info <- jmvcore::OptionVariable$new("pathway_info", pathway_info, permitted=list("nominal"))
            private$..correlation_threshold <- jmvcore::OptionNumber$new("correlation_threshold", correlation_threshold, min=0, max=1, default=0.7)
            private$..alpha_sgl <- jmvcore::OptionNumber$new("alpha_sgl", alpha_sgl, min=0, max=1, default=0.95)
            private$..lambda_sequence <- jmvcore::OptionList$new("lambda_sequence", lambda_sequence, options=list("auto", "custom", "adaptive"), default="auto")
            private$..custom_lambda <- jmvcore::OptionString$new("custom_lambda", custom_lambda, default="")
            private$..lambda_min_ratio <- jmvcore::OptionNumber$new("lambda_min_ratio", lambda_min_ratio, min=0.001, max=0.5, default=0.001)
            private$..n_lambda <- jmvcore::OptionInteger$new("n_lambda", n_lambda, min=10, max=200, default=100)
            private$..selection_criterion <- jmvcore::OptionList$new("selection_criterion", selection_criterion, options=list("cv_deviance", "cv_c_index", "aic", "bic", "ebic"), default="cv_deviance")
            private$..cv_folds <- jmvcore::OptionInteger$new("cv_folds", cv_folds, min=3, max=20, default=10)
            private$..cv_repeats <- jmvcore::OptionInteger$new("cv_repeats", cv_repeats, min=1, max=10, default=1)
            private$..ebic_gamma <- jmvcore::OptionNumber$new("ebic_gamma", ebic_gamma, min=0, max=1, default=1)
            private$..weight_type <- jmvcore::OptionList$new("weight_type", weight_type, options=list("none", "ridge_based", "univariate_based", "lasso_based"), default="none")
            private$..weight_power <- jmvcore::OptionNumber$new("weight_power", weight_power, min=0.5, max=5, default=1)
            private$..standardize_vars <- jmvcore::OptionBool$new("standardize_vars", standardize_vars, default=TRUE)
            private$..center_vars <- jmvcore::OptionBool$new("center_vars", center_vars, default=TRUE)
            private$..orthogonalize_groups <- jmvcore::OptionBool$new("orthogonalize_groups", orthogonalize_groups, default=FALSE)
            private$..max_iterations <- jmvcore::OptionInteger$new("max_iterations", max_iterations, min=100, max=10000, default=1000)
            private$..convergence_threshold <- jmvcore::OptionNumber$new("convergence_threshold", convergence_threshold, min=1e-8, max=1e-3, default=1e-6)
            private$..warm_start <- jmvcore::OptionBool$new("warm_start", warm_start, default=TRUE)
            private$..parallel_cv <- jmvcore::OptionBool$new("parallel_cv", parallel_cv, default=FALSE)
            private$..seed_value <- jmvcore::OptionInteger$new("seed_value", seed_value, default=42)
            private$..show_summary <- jmvcore::OptionBool$new("show_summary", show_summary, default=TRUE)
            private$..show_coefficients <- jmvcore::OptionBool$new("show_coefficients", show_coefficients, default=TRUE)
            private$..show_groups <- jmvcore::OptionBool$new("show_groups", show_groups, default=TRUE)
            private$..show_path <- jmvcore::OptionBool$new("show_path", show_path, default=FALSE)
            private$..show_performance <- jmvcore::OptionBool$new("show_performance", show_performance, default=TRUE)
            private$..show_validation <- jmvcore::OptionBool$new("show_validation", show_validation, default=TRUE)
            private$..plot_cv_error <- jmvcore::OptionBool$new("plot_cv_error", plot_cv_error, default=TRUE)
            private$..plot_coefficients <- jmvcore::OptionBool$new("plot_coefficients", plot_coefficients, default=TRUE)
            private$..plot_groups <- jmvcore::OptionBool$new("plot_groups", plot_groups, default=TRUE)
            private$..plot_sparsity <- jmvcore::OptionBool$new("plot_sparsity", plot_sparsity, default=FALSE)
            private$..plot_stability <- jmvcore::OptionBool$new("plot_stability", plot_stability, default=FALSE)
            private$..alpha_level <- jmvcore::OptionNumber$new("alpha_level", alpha_level, min=0.01, max=0.1, default=0.05)
            private$..confidence_intervals <- jmvcore::OptionBool$new("confidence_intervals", confidence_intervals, default=FALSE)
            private$..bootstrap_samples <- jmvcore::OptionInteger$new("bootstrap_samples", bootstrap_samples, min=100, max=2000, default=500)
            private$..stability_selection <- jmvcore::OptionBool$new("stability_selection", stability_selection, default=FALSE)
            private$..stability_threshold <- jmvcore::OptionNumber$new("stability_threshold", stability_threshold, min=0.5, max=0.95, default=0.8)
            private$..stability_subsample <- jmvcore::OptionNumber$new("stability_subsample", stability_subsample, min=0.5, max=0.9, default=0.8)
            private$..showExplanations <- jmvcore::OptionBool$new("showExplanations", showExplanations, default=TRUE)

            self$.addOption(private$..data)
    ...
    active = list(
        data = function() private$..data$value,
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Table$new(
                ...
                clearWith=list("time_var", "event_var", "pred_vars", "alpha_sgl", "selection_criterion"),
                columns=list(
                    list(name="metric", title="Metric", type="text"),
                    list(name="value", title="Value", type="text"),
                    list(name="description", title="Description", type="text"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="coefficients",
                title="Selected Coefficients",
                visible="(show_coefficients)",
                clearWith=list("pred_vars", "alpha_sgl", "lambda_sequence", "selection_criterion"),
                columns=list(
                    list(name="variable", title="Variable", type="text"),
                    list(name="group", title="Group", type="text"),
                    list(name="coefficient", title="Coefficient", type="number", format="zto"),
                    list(name="hazard_ratio", title="Hazard Ratio", type="number", format="zto"),
                    list(name="standardized_coef", title="Standardized Coef", type="number", format="zto"),
                    list(name="importance", title="Importance", type="number", format="zto"),
                    list(name="selection_frequency", title="Selection Frequency", type="number", format="pc"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="groupStructure",
                title="Group Structure",
                visible="(show_groups)",
                clearWith=list("pred_vars", "group_definition", "custom_groups"),
                columns=list(
                    list(name="group_id", title="Group ID", type="integer"),
                    list(name="group_name", title="Group Name", type="text"),
                    list(name="n_variables", title="Variables", type="integer"),
                    list(name="group_selected", title="Selected", type="text"),
                    list(name="group_penalty", title="Group Penalty", type="number", format="zto"),
                    list(name="sparsity_within", title="Within-Group Sparsity", type="number", format="pc"),
                    list(name="variables_list", title="Variables in Group", type="text"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="solutionPath",
                title="Regularization Path",
                visible="(show_path)",
                clearWith=list("alpha_sgl", "lambda_sequence"),
                columns=list(
                    list(name="lambda_index", title="Lambda Index", type="integer"),
                    list(name="lambda_value", title="Lambda", type="number", format="zto"),
                    list(name="n_selected_vars", title="Selected Variables", type="integer"),
                    list(name="n_selected_groups", title="Selected Groups", type="integer"),
                    list(name="deviance", title="Deviance", type="number", format="zto"),
                    list(name="df", title="Degrees of Freedom", type="number", format="zto"),
                    list(name="sparsity_level", title="Sparsity Level", type="number", format="pc"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="performance",
                title="Performance Metrics",
                visible="(show_performance)",
                clearWith=list("selection_criterion", "cv_folds"),
                columns=list(
                    list(name="metric", title="Metric", type="text"),
                    list(name="training", title="Training", type="number", format="zto"),
                    list(name="cv_mean", title="CV Mean", type="number", format="zto"),
                    list(name="cv_se", title="CV SE", type="number", format="zto"),
            ...
            self$add(jmvcore::Table$new(
                ...
                clearWith=list("cv_folds", "cv_repeats", "selection_criterion"),
                columns=list(
                    list(name="lambda_value", title="Lambda", type="number", format="zto"),
                    list(name="cv_error", title="CV Error", type="number", format="zto"),
                    list(name="cv_se", title="CV SE", type="number", format="zto"),
                    list(name="n_selected", title="Variables Selected", type="integer"),
                    list(name="model_rank", title="Model Rank", type="integer"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="adaptiveWeights",
                title="Adaptive Weights",
                visible="(weight_type:none)",
                clearWith=list("weight_type", "weight_power"),
                columns=list(
                    list(name="variable", title="Variable", type="text"),
                    list(name="group", title="Group", type="text"),
                    list(name="individual_weight", title="Individual Weight", type="number", format="zto"),
                    list(name="group_weight", title="Group Weight", type="number", format="zto"),
                    list(name="combined_weight", title="Combined Weight", type="number", format="zto"),
                    list(name="weight_rationale", title="Weight Rationale", type="text"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="stabilityResults",
                title="Stability Selection Results",
                visible="(stability_selection)",
                clearWith=list("stability_selection", "stability_threshold"),
                columns=list(
                    list(name="variable", title="Variable", type="text"),
                    list(name="group", title="Group", type="text"),
                    list(name="selection_probability", title="Selection Probability", type="number", format="pc"),
                    list(name="stable_selection", title="Stable Selection", type="text"),
                    list(name="first_selected", title="First Selected (Lambda)", type="number", format="zto"),
                    list(name="last_selected", title="Last Selected (Lambda)", type="number", format="zto"))))
            self$add(jmvcore::Table$new(
                options=options,
                name="comparisonTable",
                title="Method Comparison",
                visible="(show_performance)",
                clearWith=list("alpha_sgl", "selection_criterion"),
                columns=list(
                    list(name="method", title="Method", type="text"),
                    list(name="n_selected", title="Variables Selected", type="integer"),
                    list(name="n_groups_selected", title="Groups Selected", type="integer"),
                    list(name="cv_error", title="CV Error", type="number", format="zto"),
                    list(name="c_index", title="C-Index", type="number", format="zto"),
                    list(name="relative_performance", title="Relative Performance", type="text"))))
            self$add(jmvcore::Image$new(
                ...
                requiresData=TRUE,
                clearWith=list("lambda_sequence", "cv_folds", "selection_criterion")))
            self$add(jmvcore::Image$new(
                options=options,
                ...
                requiresData=TRUE,
                clearWith=list("alpha_sgl", "lambda_sequence", "pred_vars")))
            self$add(jmvcore::Image$new(
                options=options,
                ...
                visible="(plot_groups)",
                requiresData=TRUE,
                clearWith=list("group_definition", "alpha_sgl", "lambda_sequence")))
            self$add(jmvcore::Image$new(
                options=options,
                name="sparsityPlot",
                ...
                requiresData=TRUE,
                clearWith=list("alpha_sgl", "lambda_sequence", "selection_criterion")))
            self$add(jmvcore::Image$new(
                options=options,
                name="stabilityPlot",
                ...
                requiresData=TRUE,
                clearWith=list("stability_selection", "stability_threshold", "stability_subsample")))
            self$add(jmvcore::Html$new(
                options=options,
                name="explanations",
...
#' @param lambda_sequence method for selecting regularization parameter sequence
...
#' @param orthogonalize_groups whether to orthogonalize variables within groups
...
#'   intervals
#' @param bootstrap_samples number of bootstrap samples for confidence intervals
...
sparsegrouplasso <- function(
    ...
    for (v in pred_vars) if (v %in% names(data)) data[[v]] <- jmvcore::toNumeric(data[[v]])
