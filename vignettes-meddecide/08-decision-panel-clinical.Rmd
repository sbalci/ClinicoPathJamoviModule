...
## Threshold Calculator (p_t)

Use this quick snippet to compute your clinical threshold probability from your own harm/benefit assumptions.

```{r threshold-calculator, eval=FALSE}
# Enter your assumptions
harm_false_positive   <- 1   # e.g., biopsy risk/harm units
...
# Tip: Try a sensitivity range to see how p_t changes
benefit_seq <- c(2, 4, 6, 8)
pt_seq <- harm_false_positive / (harm_false_positive + benefit_seq)
data.frame(benefit_true_positive = benefit_seq, p_t = round(pt_seq, 2))
```
