...
test_that("stagemigration works", {
  ...
  # Load the test data
  # Provide robust path finding
  data_path <- normalizePath(file.path("..", "..", "data", "stage_migration_test_data.rda"), mustWork = FALSE)
  if (!file.exists(data_path)) {
      data_path <- normalizePath(file.path("data", "stage_migration_test_data.rda"), mustWork = FALSE)
  }
  if (!file.exists(data_path)) {
      data_path <- "/Users/serdarbalci/Documents/GitHub/ClinicoPathJamoviModule/data/stage_migration_test_data.rda"
  }
