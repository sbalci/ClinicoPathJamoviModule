...
ihcclusterOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcclusterOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(catVars = NULL,
                                  contVars = NULL,
                                  caseId = NULL,
...
ihcclusterResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcclusterResults",
...
ihcclusterBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcclusterBase",
