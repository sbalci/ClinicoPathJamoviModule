...
qtwistOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "qtwistOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(time_os = NULL,
                                  event_os = NULL,
                                  event_os_level = NULL,
                                  time_pfs = NULL,
                                  event_pfs = NULL,
...
qtwistResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "qtwistResults",
...
qtwistBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "qtwistBase",
