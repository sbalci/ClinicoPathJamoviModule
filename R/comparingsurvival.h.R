...
comparingSurvivalOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
comparingSurvivalResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
comparingSurvivalBase <- if (requireNamespace('jmvcore')) R6::R6Class(
