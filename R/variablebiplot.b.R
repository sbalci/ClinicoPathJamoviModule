        ...
        private = list(
            ...
            .init = function() {
                ...
                about_html <- paste0(
                    ...
                    "<li><b>Arrows (\u{2192})</b> = Features/variables (longer arrow = more important for separation)</li>",
                    ...
                    "<li><b>Angle between arrows</b> = Correlation (small angle = positive, 90\u{00B0} = uncorrelated, 180\u{00B0} = negative)</li>",
                    "</ul>",
                    ...
                    "<ul>",
                    "<li>Look for <b>long arrows pointing toward late-stage group</b> \u{2192} features associated with advanced disease</li>",
                    "<li>Check <b>contribution table</b> \u{2192} Top 3 features are your best biomarkers</li>",
                    "<li>Examine <b>group separation</b> \u{2192} Clear gap = good discrimination</li>",
                    "</ul>",
                    "</div>",
            ...
            .addContributionInterpretation = function(contrib_df) {
                ...
                interpretation_html <- paste0(
                    ...
                    if (total_top3 > 70 && self$options$contributionMetric == "squared") {
                        paste0(
                            "<li><b>Focused pattern:</b> A few key features drive most of the separation. ",
                            "These are your best candidate biomarkers.</li>"
                        )
                    } else if (total_top3 < 40 && self$options$contributionMetric == "squared") {
                        paste0(
                            "<li><b>Distributed pattern:</b> Contribution is spread across many features. ",
                            "Group differences may be subtle or multifactorial.</li>"
                        )
                    } else {
                        paste0(
                            "<li><b>Moderate pattern:</b> Several features contribute to separation. ",
                    ...
                    "<li>Features with high Quality (Cos\u{00B2}) are well-represented in this 2D view</li>",
                    "</ul>",
            ...
            .generateSummary = function(result, method_name) {
                ...
                n_obs <- if (method_name == "PCA") {
                    nrow(result$x)
                } else if (method_name == "LDA") {
                    nrow(private$.lda_scores)
                } else {
                ...
                if (self$options$showSummary) {
                    summary_text <- sprintf(
                        ...
                        if (total_var > 70) {
                            paste0(
                                "These two components capture most of the important information (",
                            ...
                            paste0(
                                "These components capture a moderate amount of information (",
                            ...
                            paste0(
                                "These components capture relatively little information (",
                ...
                if (self$options$showReport) {
                    private$.generateReport(
                        result, method_name, n_obs, n_features, n_groups,
                        var1, var2, total_var
                    )
                }
            ...
            .generateReport = function(result, method_name, n_obs, n_features, n_groups,
                ...
                separation_quality <- if (total_var > 70) {
                    "clear separation between groups"
                } else if (total_var > 50) {
                    "moderate separation between groups"
                } else {
            ...
            .generateInterpretationGuide = function(method_name) {
                guide_html <- paste0(
                    ...
                    ", colored by group.</li>",
                    "<li><b>Arrows (\u{2192})</b> represent features/variables. ",
                    ...
                    "<ul>",
                    "<li><b>Arrows pointing in similar directions</b> (small angle) \u{2192} Features are positively correlated</li>",
                    "<li><b>Arrows at ~90\u{00B0}</b> \u{2192} Features are uncorrelated (independent information)</li>",
                    "<li><b>Arrows pointing opposite directions</b> (180\u{00B0}) \u{2192} Features are negatively correlated</li>",
                    "<li><b>Long arrows toward a group</b> \u{2192} Important features for that group</li>",
                    "</ul>",
...
# ============================================',
            ...
            .biplotPCA = function(image, ggtheme, theme, ...) {
                ...
                p <- p +
                    labs(
                        title = paste0("PCA ", biplot_type_label, " Biplot"),
            ...
            .loadingPlot = function(image, ggtheme, theme, ...) {
                ...
                p <- ggplot(loadings, aes(x = Variable, y = Contribution)) +
                    ...
                    coord_flip() +
                    labs(
                        title = "Variable Contribution to Selected Components",
                        x = "Variable",
            ...
            .biplotLDA = function(image, ggtheme, theme, ...) {
                ...
                if (is.null(lda_result) || is.null(lda_scores)) {
                    return()
                }
