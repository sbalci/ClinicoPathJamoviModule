...
linechartOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "linechartOptions",
...
linechartResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
linechartBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "linechartBase",
