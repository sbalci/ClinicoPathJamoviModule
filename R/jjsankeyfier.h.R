...
jjsankeyfierOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjsankeyfierOptions",
...
jjsankeyfierResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjsankeyfierResults",
...
jjsankeyfierBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjsankeyfierBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,31),
                options = options,
                results = jjsankeyfierResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
jjsankeyfier <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jjsankeyfier requires jmvcore to be installed (restart may be required)")
    ...
    options <- jjsankeyfierOptions$new(
    ...
    analysis <- jjsankeyfierClass$new(
        options = options,
        data = data)
