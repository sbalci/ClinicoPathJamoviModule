...
vtree3Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "vtree3Options",
    ...
    active = list(
        ...
        survival = function() private$..survival$value,
        labs = function() private$..labs$value,
...
vtree3Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "vtree3Results",
...
vtree3Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "vtree3Base",
...
vtree3 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("vtree3 requires jmvcore to be installed (restart may be required)")
