...
ordinalrocOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ordinalrocOptions",
...
ordinalrocResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ordinalrocResults",
...
ordinalrocBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ordinalrocBase",
