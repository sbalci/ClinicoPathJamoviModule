      ...
      .valueOfInformationData = NULL,
            ...
            .populateNMBAnalysis = function(nmbAnalysis) {
                ...
                html_content <- paste0(
                    ...
                    "<div style='background-color: rgba(33, 163, 188, 0.21); padding: 10px; margin: 10px 0; border-left: 4px solid #bee5eb; color: inherit;'>",
            ...
            .handleError = function(context, error) {
                ...
                if (!is.null(html)) {
                    error_html <- paste0(
                        ...
                        "<pre style='background-color: rgba(88, 88, 88, 0.06); padding: 10px; margin: 5px 0; color: inherit;'>",
