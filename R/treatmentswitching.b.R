    ...
    R6::R6Class(
        ...
        private = list(
            ...
            .run = function() {
                ...
                private$.identifySwitchingPatterns(
                    clean_data, time_var, event_var,
                    treatment_var, switch_time_var, actual_treatment_var
                )

                # Perform switching analysis
                private$.performSwitchingAnalysis(
                    clean_data, time_var, event_var,
                ...
                if (self$options$methodComparison) {
                    private$.compareMethodsAnalysis(
                        clean_data, time_var, event_var,
            ...
            .plotSurvivalCurves = function(image, ...) {
                if (is.null(private$switching_data)) {
                    return()
                }
            ...
            .plotSensitivity = function(image, ...) {
                if (is.null(private$sensitivity_results)) {
                    return()
                }
