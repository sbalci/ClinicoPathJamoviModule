...
reportcat2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reportcat2Options",
...
reportcat2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reportcat2Results",
...
reportcat2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "reportcat2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = reportcat2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
reportcat2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("reportcat2 requires jmvcore to be installed (restart may be required)")
