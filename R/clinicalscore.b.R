...
#' @import jmvcore
#' @return An \code{R6} class generator object for the \code{clinicalscoreClass} backend; used internally by the jamovi analysis wrapper and not called directly.
