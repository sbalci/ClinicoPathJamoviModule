    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Table$new(
                ...
                visible="(spatial_analysis && length(location_var) > 0)",
                columns=list(
                    list(
                        `name`="location", 
                        `title`="Location", 
            ...
            self$add(jmvcore::Table$new(
                ...
                visible="(incubation_period && length(exposure_date_var) > 0)",
                columns=list(
                    list(
                        `name`="statistic", 
                        `title`="Statistic", 
            ...
            self$add(jmvcore::Image$new(
                ...
                visible="(epidemic_curve_plot && length(date_onset) > 0)",
                width=600,
                height=400,
                requiresData=TRUE))
            self$add(jmvcore::Image$new(
            ...
            self$add(jmvcore::Image$new(
                ...
                visible="(spatial_plot && spatial_analysis && length(location_var) > 0)",
                width=600,
                height=400,
                requiresData=TRUE))
            self$add(jmvcore::Image$new(
