            ...
            tryCatch({
                ...
                private$.showMessage(
                    paste0("<html><body><h3>Analysis Error</h3><p>",
                           "Error in adaptive LASSO fitting: ", htmltools::htmlEscape(e$message),
        ...
        .encodeEventIndicator = function(event_raw) {
                    ...
                    if (!(event_level %in% event_levels)) {
                        return(list(
                            ...
                            message = paste0(
                                ...
                                htmltools::htmlEscape(event_level),
                    ...
                    if (!is.null(censor_level) && !(censor_level %in% event_levels)) {
                        return(list(
                            ...
                            message = paste0(
                                ...
                                htmltools::htmlEscape(censor_level),
                                "') is not present in the event variable.</p></body></html>"
                            )
                        ))
                    }
            ...
            return(list(
                ...
                message = paste0(
                    ...
                    htmltools::htmlEscape(paste(unique_vals, collapse = ", ")),
        ...
        .buildLambdaSequence = function() {
            ...
            if (mode == "single") {
                ...
                if (is.na(lambda_single) || lambda_single <= 0) {
                    jmvcore::reject("Single lambda value must be > 0.")
                }
            ...
            if (mode == "custom") {
                ...
                if (is.na(lambda_max) || is.na(lambda_min) || lambda_max <= lambda_min || lambda_min <= 0) {
                    jmvcore::reject("For custom lambda, require: lambda_max > lambda_min > 0.")
                }
