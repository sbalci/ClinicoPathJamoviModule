...
categoricaladvancedClass <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        ...
        private = list(
            ...
            .interpretGamma = function(gamma) {
                ...
                gamma <- abs(gamma)
                if (gamma < 0.1) {
                    return("Very weak ordinal association")
                }
                if (gamma < 0.3) {
                    return("Weak ordinal association")
                }
                if (gamma < 0.5) {
                    return("Moderate ordinal association")
                }
                if (gamma < 0.7) {
                    return("Strong ordinal association")
                }
            ...
            .interpretUC = function(uc) {
                ...
                if (uc < 0.1) {
                    return("Very low uncertainty reduction")
                }
                if (uc < 0.3) {
                    return("Low uncertainty reduction")
                }
                if (uc < 0.5) {
                    return("Moderate uncertainty reduction")
                }
            ...
            .generateInterpretation = function() {
                ...
                html <- paste0(
                    html, "<p>This analysis examines the association between <strong>",
