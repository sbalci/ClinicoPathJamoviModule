...
swimmerplot1Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "swimmerplot1Options",
...
swimmerplot1Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "swimmerplot1Results",
...
swimmerplot1Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "swimmerplot1Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = swimmerplot1Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
swimmerplot1 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("swimmerplot1 requires jmvcore to be installed (restart may be required)")
    ...
    options <- swimmerplot1Options$new(
        patientID = patientID,
        start = start,
        end = end,
        event = event,
    ...
    analysis <- swimmerplot1Class$new(
        options = options,
        data = data)
