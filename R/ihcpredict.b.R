...
ihcpredictOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcpredictOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(useStoredModel = "stored",
                                  trainingFile = "",
...
ihcpredictResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcpredictResults",
...
ihcpredictBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "ihcpredictBase",
