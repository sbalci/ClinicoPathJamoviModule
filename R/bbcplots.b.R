    ...
    private = list(
        ...
        .perform_ttest_analysis = function(data, y_var, x_var) {
            ...
            result_html <- paste0(
                ...
                "<p><strong>Group Means:</strong> ", htmltools::htmlEscape(groups[1]), " = ", round(mean(group1_data), 3),
                ", ", htmltools::htmlEscape(groups[2]), " = ", round(mean(group2_data), 3), "</p>",
        ...
        .add_chi_square_assumptions_note = function(contingency_table) {
            ...
            if (min_expected < 5) {
                return("<p style='color: #f57c00; font-style: italic;'> Warning: Some expected cell counts < 5. Consider Fisher's exact test for small samples.</p>")
            }
            return("")
        },
