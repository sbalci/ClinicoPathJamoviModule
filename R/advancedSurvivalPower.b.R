        ...
        private = list(
            ...
            .run = function() {
                ...
                if (length(validation_errors) > 0) {
                    error_html <- paste(
                        "<div style='background-color: rgba(255, 202, 33, 0.23); border: 1px solid #ffeaa7; padding: 10px; border-radius: 5px; margin-bottom: 15px; color: inherit;'>",
                ...
                if (calc_type == "power") {
                    ...
                    self$results$power_result$setContent(paste(
                        ...
                        " (", round(result * 100, 1), "%)",
                        "</p>",
                        "<div style='background-color: rgba(138, 155, 172, 0.06); padding: 15px; border-radius: 5px; margin-top: 15px; color: inherit;'>",
                        ...
                        "</div>",
                        "<div style='background-color: rgba(33, 149, 188, 0.1); padding: 15px; border-radius: 5px; margin-top: 15px; color: inherit;'>",
                    ...
                    if (k != 1) {
                        ...
                        sample_size_text <- paste(
                            ...
                            "</div>",
                            "<div style='background-color: rgba(89, 177, 33, 0.09); padding: 15px; border-radius: 5px; margin-top: 15px; color: inherit;'>",
