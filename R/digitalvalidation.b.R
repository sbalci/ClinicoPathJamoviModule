...
digitalvalidationClass <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        ...
        private = list(
            ...
            .validationplot = function(image, ggtheme, theme, ...) {
                ...
                # Main scatter plot
                p1 <- ggplot2::ggplot(
                    data.frame(Reference = data$reference, Test = data$test),
            ...
            .residualplot = function(image, ggtheme, theme, ...) {
                ...
                p <- ggplot2::ggplot(
                    data.frame(Means = data$means, Differences = data$differences),
            ...
            .generateValidationInterpretation = function(reference, test) {
                ...
                interpretation <- paste0(
                    ...
                    " (", ifelse(correlation >= 0.95, "Excellent",
                        ifelse(correlation >= 0.90, "Good", "Needs improvement")
                    ), ")</li>",
