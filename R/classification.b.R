...
classificationClass <- if (requireNamespace("jmvcore")) {
    R6::R6Class(
        "classificationClass",
        ...
        private = list(
            ...
            .createBalancedLearner = function() {
                ...
                if (self$options$balancingMethod == "upsample") {
                        ...
                        tryCatch(
                            {
                                ...
                                po_balance <- po("classbalancing",
                                    ...
                                    reference = "major",
                                    shuffle = TRUE
                                ) # Shuffle for synthetic-like effect
                            },
                            error = function(e) {
                    ...
                    warning(paste(
                        "Unknown balancing method:", self$options$balancingMethod,
                        "- Using no balancing"
                    ))
                    return(base_learner)
                }
