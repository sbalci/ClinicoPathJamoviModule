...
powercompriskOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "powercompriskOptions",
...
powercompriskResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "powercompriskResults",
...
powercompriskBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "powercompriskBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,1),
                options = options,
                results = powercompriskResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
powercomprisk <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("powercomprisk requires jmvcore to be installed (restart may be required)")
    ...
    options <- powercompriskOptions$new(
    ...
    analysis <- powercompriskClass$new(
        options = options,
        data = data)
