...
.jmvrefs <- list(
    ...
    `BlandAltman1986`=list(
        `type`="article", 
        `author`="Bland, J. M., & Altman, D. G.", 
        `year`=1986, 
    ...
    `BlandAltman1999`=list(
        ...
        `url`="https://pubmed.ncbi.nlm.nih.gov/10501650/"), 
    `BonettWright2000`=list(
        `type`="article", 
        `author`="Bonett, D. G., & Wright, T. A.", 
        `year`=2000, 
    ...
    `ConditionalDependenceDiagnosticTests`=list(
        `type`="article", 
        ...
        `publisher`="Preventive Veterinary Medicine", 
        `volume`=45, 
        `issue`="1-2", 
        `pages`="107-122", 
    ...
    `DeeksMacaskillIrwig2005`=list(
        `type`="article", 
        `author`="Deeks, J. J., Macaskill, P., & Irwig, L.", 
        `year`=2005, 
        ...
        `pmid`=16085191, 
        `url`="https://doi.org/10.1016/j.jclinepi.2005.01.016"), 
    ...
    `Dudgeon2021`=list(
        `type`="article", 
        `author`="Dudgeon, S. N., Wen, S., Hanna, M. G., et al.", 
        `year`=2021, 
        ...
        `pmid`=34881099, 
        `url`="https://doi.org/10.4103/jpi.jpi_83_20"), 
    `Elfer2022`=list(
        `type`="article", 
        `author`="Elfer, K., Dudgeon, S., Garcia, V., et al.", 
        `year`=2022, 
        `title`="Pilot study to evaluate tools to collect pathologist annotations for validating machine learning algorithms", 
        `publisher`="Journal of Medical Imaging (Bellingham)", 
        `volume`=9, 
        `issue`=4, 
        `pages`="047501", 
        `doi`="10.1117/1.JMI.9.4.047501", 
        `pmid`=35911208, 
        `url`="https://doi.org/10.1117/1.JMI.9.4.047501"), 
    `Elfer2024`=list(
        `type`="article", 
        `author`="Elfer, K., Gardecki, E., Garcia, V., et al.", 
        `year`=2024, 
        `title`="Reproducible Reporting of the Collection and Evaluation of Annotations for Artificial Intelligence Models (CLEARR-AI)", 
        ...
        `pmid`=38286221, 
        `url`="https://doi.org/10.1016/j.modpat.2024.100439"), 
    `FDA_CDRH_RST_Catalog_2025`=list(
        `type`="website", 
        `author`="U.S. Food and Drug Administration, Center for Devices and Radiological Health.", 
        `year`=2025, 
        `title`="Catalog of Regulatory Science Tools to Help Assess New Medical Devices (Digital Pathology program area)", 
        `publisher`="U.S. Food and Drug Administration", 
        `url`="https://cdrh-rst.fda.gov/"), 
    `FDA_RST24MD06_SegValWSI_2025`=list(
        `type`="software", 
        `author`="Arab, A., Kahaki, S., & Chen, W.", 
        `year`=2025, 
        `title`="SegVal-WSI: Whole Slide Image Segmentation Algorithm Performance Assessment Tool (Regulatory Science Tool RST24MD06.02)", 
        `publisher`="U.S. Food and Drug Administration, Center for Devices and Radiological Health", 
        `url`="https://cdrh-rst.fda.gov/segval-wsi-whole-slide-image-segmentation-algorithm-performance-assessment-tool"), 
    `FDA_RST24MD19_DxGoals_2025`=list(
        `type`="software", 
        `author`="Nguyen, N. T., & Pennello, G. A.", 
        `year`=2025, 
        `title`="DxGoals: A Software Tool for Determining, Visualizing, and Analyzing Performance Goals for a Diagnostic Test (Regulatory Science Tool RST24MD19.01)", 
        `publisher`="U.S. Food and Drug Administration, Center for Devices and Radiological Health", 
        `url`="https://cdrh-rst.fda.gov/dxgoals-software-tool-determining-visualizing-and-analyzing-performance-goals-diagnostic-test"), 
    `FFTrees`=list(
        `type`="software", 
    ...
    `Garcia2022`=list(
        `type`="article", 
        `author`="Garcia, V., Elfer, K., Peeters, D. J. E., et al.", 
        `year`=2022, 
        ...
        `pmid`=35626070, 
        `url`="https://doi.org/10.3390/cancers14102467"), 
    `GGally`=list(
        `type`="software", 
    ...
    `MacKinnonWhite1985`=list(
        `type`="article", 
        `author`="MacKinnon, J. G., & White, H.", 
        `year`=1985, 
    ...
    `McGraw1996`=list(
        ...
        `url`="https://doi.org/10.1037/1082-989X.1.1.30"), 
    `MendelianRandomization`=list(
        `type`="software", 
    ...
    `NguyenPennello2024`=list(
        `type`="article", 
        `author`="Nguyen, N. T., & Pennello, G. A.", 
        `year`=2024, 
        `title`="DxGoals: A Software Tool for Determining and Analyzing Clinically Meaningful Classification Accuracy Goals for Diagnostic Tests", 
        `publisher`="The Journal of Applied Laboratory Medicine", 
        `volume`=9, 
        `issue`=5, 
        `pages`="952-962", 
        `doi`="10.1093/jalm/jfae054", 
        `pmid`=39225456, 
        `url`="https://doi.org/10.1093/jalm/jfae054"), 
    `NPHMC`=list(
        `type`="software", 
    ...
    `Pennello2021`=list(
        ...
        `publisher`="Biostatistics & Epidemiology", 
        `volume`=5, 
        `issue`=2, 
        `pages`="149-168", 
        `doi`="10.1080/24709360.2021.1878406", 
        `url`="https://doi.org/10.1080/24709360.2021.1878406"), 
    `PMCMR`=list(
        `type`="software", 
        `author`="Pohlert, T.", 
        `year`=2018, 
    ...
    `RileyHigginsDeeks2011`=list(
        `type`="article", 
        `author`="Riley, R. D., Higgins, J. P. T., & Deeks, J. J.", 
        `year`=2011, 
    ...
    `Salgado2015`=list(
        `type`="article", 
        `author`="Salgado, R., Denkert, C., Demaria, S., et al.", 
        `year`=2015, 
    ...
    `Schuirmann1987`=list(
        ...
        `publisher`="Journal of Pharmacokinetics and Biopharmaceutics", 
        `volume`=15, 
        `issue`=6, 
        `pages`="657-680", 
    ...
    `SweetingSuttonLambert2004`=list(
        `type`="article", 
        `author`="Sweeting, M. J., Sutton, A. J., & Lambert, P. C.", 
        `year`=2004, 
        ...
        `pmid`=15116347, 
        `note`="Erratum: Statistics in Medicine 2006;25(15):2700, doi 10.1002/sim.2536", 
        `url`="https://doi.org/10.1002/sim.1761"), 
    ...
    `ZwindermanBossuyt2008`=list(
        `type`="article", 
        `author`="Zwinderman, A. H., & Bossuyt, P. M.", 
        `year`=2008, 
        ...
        `pmid`=17611957, 
        `url`="https://doi.org/10.1002/sim.2992"), 
    `afex`=list(
        `type`="software", 
        `author`="Singmann, H.", 
        `year`=2018, 
