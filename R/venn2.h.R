...
venn2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "venn2Options",
...
venn2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "venn2Results",
...
venn2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "venn2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = venn2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
venn2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("venn2 requires jmvcore to be installed (restart may be required)")
