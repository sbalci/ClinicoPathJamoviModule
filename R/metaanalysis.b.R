metaanalysisClass <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "metaanalysisClass",
        ...
        private = list(
            ...
            .executeAnalysis = function(analysis_type, clean_data) {
                ...
                private$.populateStudySummary(
                    clean_data$effects, clean_data$variances,
            ...
            .generateClinicalSummary = function(analysis_type, clean_data) {
                ...
                if (is.null(clean_data) || clean_data$n_studies < 2) {
                    return()
                }
            ...
            .generateGenericSummary = function(clean_data) {
                ...
                return(paste0(
                    "Meta-analysis of ", clean_data$n_studies, " studies examining ",
            ...
            .performMetaRegression = function(effects, variances, studies) {
                ...
                if (is.null(moderator_vars) || length(moderator_vars) == 0) {
                    return()
                }
                ...
                tryCatch(
                    {
                        ...
                        meta_reg <- metafor::rma(
                            yi = mod_effects, vi = mod_variances,
            ...
            .forestPlot = function(image, ...) {
                ...
                tryCatch(
                    {
                        ma_model <- metafor::rma(
                            yi = clean_effects, vi = clean_variances,
            ...
            .plotSROC = function(image, ...) {
                ...
                plot(1, 1,
                    main = "SROC Plot - Implementation Pending",
            ...
            .plotNetwork = function(image, ...) {
                ...
                plot(1, 1,
                    main = "Network Plot - Implementation Pending",
                    xlab = "", ylab = ""
                )
