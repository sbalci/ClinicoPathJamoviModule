    ...
    private = list(
        ...
        .populateWelcomeMessage = function() {
            ...
            html_content <- paste0(
                ...
                "<li><strong style='color: #e74c3c;'>TOX</strong>: Time with treatment toxicity (typically \u{03BC} = 0.3-0.7)</li>",
                "<li><strong style='color: #27ae60;'>TWiST</strong>: Time without symptoms or toxicity (\u{03BC} = 1.0, perfect health)</li>",
                "<li><strong style='color: #f39c12;'>REL</strong>: Time after disease relapse/progression (typically \u{03BC} = 0.3-0.6)</li>",
                "</ul>",
                "<p style='margin-top: 10px;'><strong>Formula:</strong> ",
                "Q-TWiST = \u{03BC}<sub>TOX</sub> \u{00D7} E[TOX] + \u{03BC}<sub>TWiST</sub> \u{00D7} E[TWiST] + \u{03BC}<sub>REL</sub> \u{00D7} E[REL]</p>",
                "</div>",
                "<div style='background-color: rgba(255, 202, 33, 0.23); padding: 15px; border-left: 4px solid #ffc107; margin: 15px 0; color: inherit;'>",
                ...
                "<li>Navigate to: <em>Data \u{2192} Time Interval Calculator</em></li>",
                ...
                "</ol>",
                "<div style='background-color: rgba(138, 155, 172, 0.06); padding: 10px; margin: 10px 0; border-radius: 5px; color: inherit;'>",
                ...
                "</tr>",
                "</table>",
                "<div style='background-color: rgba(33, 162, 64, 0.19); padding: 15px; border-left: 4px solid #28a745; margin: 15px 0; color: inherit;'>",
                ...
                "</ul>",
                "</div>",
                "<div style='background-color: rgba(33, 163, 188, 0.21); padding: 15px; border-left: 4px solid #17a2b8; margin: 15px 0; color: inherit;'>",
                ...
                ifelse(has_os_time && has_os_event && has_pfs_time && has_pfs_event && has_treatment && has_toxicity,
                    paste0(
                        "<div style='background-color: rgba(33, 162, 64, 0.19); padding: 15px; border: 2px solid #28a745; margin: 15px 0; border-radius: 5px; color: inherit;'>",
                    ...
                    paste0(
                        "<div style='background-color: rgba(216, 33, 50, 0.18); padding: 15px; border: 2px solid #dc3545; margin: 15px 0; border-radius: 5px; color: inherit;'>",
        ...
        .populateMethodologyExplanation = function() {
            html_content <- paste0(
                ...
                "<p style='margin-left: 20px;'><strong>Utility weight (\u{03BC}<sub>TOX</sub>):</strong> ",
                ...
                "<p style='margin-left: 20px;'><strong>Utility weight (\u{03BC}<sub>TWiST</sub>):</strong> ",
                ...
                "<p style='margin-left: 20px;'><strong>Utility weight (\u{03BC}<sub>REL</sub>):</strong> ",
                ...
                "<div style='background-color: rgba(138, 155, 172, 0.06); padding: 15px; margin: 15px 0; border-left: 4px solid #6c757d; color: inherit;'>",
                "<h4 style='margin-top: 0;'>Step 1: Partition Overall Survival</h4>",
                "<p>Using restricted mean survival time (RMST) methodology:</p>",
                "<ul>",
                "<li><strong>E[OS]</strong> = RMST for overall survival up to time \u{03C4}</li>",
                "<li><strong>E[PFS]</strong> = RMST for progression-free survival up to time \u{03C4}</li>",
                ...
                "</ul>",
                "</div>",
                "<div style='background-color: rgba(33, 149, 188, 0.1); padding: 15px; margin: 15px 0; border-left: 4px solid #3498db; color: inherit;'>",
                "<h4 style='margin-top: 0;'>Step 2: Apply Utility Weights</h4>",
                "<p style='font-family: monospace; font-size: 1.1em; margin: 10px 0;'>",
                "Q-TWiST = \u{03BC}<sub>TOX</sub> \u{00D7} E[TOX] + \u{03BC}<sub>TWiST</sub> \u{00D7} E[TWiST] + \u{03BC}<sub>REL</sub> \u{00D7} E[REL]",
                "</p>",
                ...
                "</div>",
                "<div style='background-color: rgba(255, 202, 33, 0.23); padding: 15px; margin: 15px 0; border-left: 4px solid #ffc107; color: inherit;'>",
                "<h4 style='margin-top: 0;'>Step 3: Compare Treatments</h4>",
                "<p style='font-family: monospace;'>\u{0394} Q-TWiST = Q-TWiST<sub>Treatment A</sub> - Q-TWiST<sub>Treatment B</sub></p>",
                "<p>Positive \u{0394} Q-TWiST indicates Treatment A provides more quality-adjusted survival.</p>",
                ...
                "<p style='margin-left: 20px;'><strong>E[TOX] = </strong> Duration of window \u{00D7} Probability of grade 3-4 toxicity</p>",
                "</div>",
                "<div style='margin: 15px 0;'>",
                ...
                "<li><strong>Clinical relevance:</strong> Even if statistically significant, is \u{0394} Q-TWiST clinically meaningful?</li>",
                "</ul>",
                "<h3 style='color: #2c3e50; margin-top: 25px;'>Interpretation Guidelines</h3>",
                "<div style='background-color: rgba(33, 162, 64, 0.19); padding: 15px; margin: 15px 0; border-left: 4px solid #28a745; color: inherit;'>",
                ...
                "</ul>",
                "</div>",
                "<div style='background-color: rgba(33, 163, 188, 0.21); padding: 15px; margin: 15px 0; border-left: 4px solid #17a2b8; color: inherit;'>",
                ...
                "<li><strong>Two-sided tests:</strong> Tests whether \u{0394} Q-TWiST differs from zero</li>",
                "</ul>",
                "</div>",
        ...
        .performThresholdAnalysis = function(state_results) {
            ...
            threshold_results <- list(
                list(
                    parameter = "\u{03BC}_TOX (Toxicity Utility)",
                ...
                list(
                    parameter = "\u{03BC}_REL (Relapse Utility)",
        ...
        .populateClinicalGuidance = function() {
            html_content <- paste0(
                ...
                "<p style='margin-left: 20px;'>\u{2192} Treatment A provides better quality survival<br>",
                "\u{2192} Strong argument for Treatment A in most patients</p>",
                "<h4>Scenario 2: Treatment A has longer OS but more TOX</h4>",
                "<p style='margin-left: 20px;'>\u{2192} Survival benefit comes with toxicity burden<br>",
                "\u{2192} Q-TWiST accounts for this trade-off<br>",
                "\u{2192} Patient preferences critical</p>",
                "<h4>Scenario 3: Similar Q-TWiST but different state distributions</h4>",
                "<p style='margin-left: 20px;'>\u{2192} Treatments achieve similar quality-adjusted survival through different paths<br>",
                "\u{2192} Consider patient-specific tolerance for toxicity vs. risk of relapse</p>",
                "</div>",
                "<div style='background-color: rgba(255, 202, 33, 0.23); padding: 15px; border-left: 4px solid #ffc107; margin: 15px 0; color: inherit;'>",
                ...
                "<li>Patients valuing toxicity avoidance highly \u{2192} lower \u{03BC}<sub>TOX</sub></li>",
                "<li>Patients tolerating toxicity well \u{2192} higher \u{03BC}<sub>TOX</sub></li>",
                "</ul>",
                "</div>",
                "<div style='background-color: rgba(33, 149, 188, 0.1); padding: 15px; border-left: 4px solid #3498db; margin: 15px 0; color: inherit;'>",
                ...
                "<li><strong>Statistical significance \u{2260} clinical importance:</strong> ",
                ...
                "<li>Treatment difference (\u{0394} Q-TWiST) with 95% CI and p-value</li>",
        ...
        .populateFormulas = function() {
            html_content <- paste0(
                ...
                "<div style='background-color: rgba(138, 155, 172, 0.06); padding: 15px; margin: 15px 0; color: inherit;'>",
                "<h3 style='color: #2c3e50;'>1. Restricted Mean Survival Time (RMST)</h3>",
                "<p><strong>Definition:</strong> Area under the Kaplan-Meier survival curve up to time \u{03C4}</p>",
                "<p style='font-family: monospace; font-size: 1.1em; margin: 15px 0;'>",
                "RMST(\u{03C4}) = \u{222B}<sub>0</sub><sup>\u{03C4}</sup> S(t) dt</p>",
                ...
                "</div>",
                "<div style='background-color: rgba(33, 149, 188, 0.1); padding: 15px; margin: 15px 0; color: inherit;'>",
                "<h3 style='color: #2c3e50;'>2. Health State Partition</h3>",
                "<p><strong>Overall Survival RMST:</strong></p>",
                "<p style='font-family: monospace; margin-left: 20px;'>E[OS] = RMST<sub>OS</sub>(\u{03C4})</p>",
                "<p><strong>Progression-Free Survival RMST:</strong></p>",
                "<p style='font-family: monospace; margin-left: 20px;'>E[PFS] = RMST<sub>PFS</sub>(\u{03C4})</p>",
                ...
                "E[TOX] + E[TWiST] + E[REL] = E[OS]</p>",
                "</div>",
                "<div style='background-color: rgba(255, 202, 33, 0.23); padding: 15px; margin: 15px 0; color: inherit;'>",
                ...
                "<p>Where:</p>",
                "<ul>",
                "<li>\u{03BC}<sub>TOX</sub> \u{2208} [0, 1]: Utility weight for toxicity state</li>",
                "<li>\u{03BC}<sub>TWiST</sub> = 1.0: Reference utility for good quality state</li>",
                "<li>\u{03BC}<sub>REL</sub> \u{2208} [0, 1]: Utility weight for relapse state</li>",
                "</ul>",
                "</div>",
                "<div style='background-color: rgba(33, 162, 64, 0.19); padding: 15px; margin: 15px 0; color: inherit;'>",
                ...
                "\u{0394} Q-TWiST = Q-TWiST<sub>B</sub> - Q-TWiST<sub>A</sub></p>",
                "<p><strong>Standard Error (parametric):</strong></p>",
                "<p style='font-family: monospace; margin: 15px 20px;'>",
                "SE(\u{0394} Q-TWiST) = \u{221A}[SE(Q-TWiST<sub>A</sub>)<sup>2</sup> + SE(Q-TWiST<sub>B</sub>)<sup>2</sup>]</p>",
                "<p><strong>Test Statistic:</strong></p>",
                "<p style='font-family: monospace; margin: 15px 20px;'>",
                "Z = \u{0394} Q-TWiST / SE(\u{0394} Q-TWiST)</p>",
                "<p><strong>Two-sided p-value:</strong></p>",
                "<p style='font-family: monospace; margin: 15px 20px;'>",
                "p = 2 \u{00D7} [1 - \u{03A6}(|Z|)]</p>",
                "<p>Where \u{03A6} is the standard normal CDF</p>",
                "</div>",
                "<div style='background-color: rgba(33, 163, 188, 0.21); padding: 15px; margin: 15px 0; color: inherit;'>",
                ...
                "<li>Store \u{0394} Q-TWiST<sub>b</sub></li>",
                "</ul>",
                "</li>",
                "<li>Calculate percentile CI from bootstrap distribution</li>",
                "</ol>",
                "<p><strong>Percentile CI (\u{03B1} = 0.05 for 95% CI):</strong></p>",
                "<p style='font-family: monospace; margin: 15px 20px;'>",
                "CI = [\u{0394} Q-TWiST<sub>(\u{03B1}/2)</sub>, \u{0394} Q-TWiST<sub>(1-\u{03B1}/2)</sub>]</p>",
                "</div>",
                "</div>"
            )
        ...
        .populateReferences = function() {
            html_content <- paste0(
                ...
                "</ol>",
                "<div style='background-color: rgba(33, 149, 188, 0.1); padding: 15px; margin-top: 30px; border-left: 4px solid #3498db; color: inherit;'>",
        ...
        .plotPartitionedSurvival = function(image, ...) {
            ...
            p <- ggplot2::ggplot() +
                ...
                ggplot2::labs(
                    ...
                    subtitle = paste("Time horizon (\u{03C4}) =", round(state_results[[1]]$tau, 1), "months"),
                    x = "Time (months)",
        ...
        .plotQTWISTComparison = function(image, ...) {
            ...
            p <- ggplot2::ggplot(plot_data, ggplot2::aes(x = Treatment, y = QualityAdjusted, fill = Component)) +
                ...
                ggplot2::labs(
                    ...
                    subtitle = sprintf(
                        "Utility weights: \u{03BC}_TOX=%.2f, \u{03BC}_TWiST=%.2f, \u{03BC}_REL=%.2f",
        ...
        .plotSensitivity = function(image, ...) {
            ...
            p <- ggplot2::ggplot(plot_data, ggplot2::aes(x = Utility_TOX, y = Utility_REL, fill = Delta_QTWIST)) +
                ...
                ggplot2::labs(
                    ...
                    x = "Toxicity Utility (\u{03BC}_TOX)",
                    y = "Relapse Utility (\u{03BC}_REL)",
