...
#' @export
#' @return An \code{R6} class generator object for the \code{transformationmodelsClass} backend; used internally by the jamovi analysis wrapper and not called directly.
    ...
    private = list(
        ...
        .populateMethodExplanation = function() {
            ...
            content <- paste0(
                ...
                "<li><strong>Box-Cox:</strong> Power transformation with parameter \u{03BB}, including log transformation (\u{03BB}=0)</li>",
                ...
                "<ul>",
                "<li>\u{03BB} = 0: log(y) transformation</li>",
                "<li>\u{03BB} = 1: no transformation (linear)</li>",
                "<li>\u{03BB} \u{2260} 0,1: (y^\u{03BB} - 1)/\u{03BB} power transformation</li>",
                "</ul>",
