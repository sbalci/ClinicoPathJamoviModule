...
survivalPowerComprehensiveOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "survivalPowerComprehensiveOptions",
...
survivalPowerComprehensiveResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "survivalPowerComprehensiveResults",
...
survivalPowerComprehensiveBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "survivalPowerComprehensiveBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = survivalPowerComprehensiveResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#'
#' @export
survivalPowerComprehensive <- function(
    data,
    method_category = "standard",
    calculation_type = "sample_size",
    statistical_method = "log_rank_schoenfeld",
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("survivalPowerComprehensive requires jmvcore to be installed (restart may be required)")
    ...
    options <- survivalPowerComprehensiveOptions$new(
    ...
    analysis <- survivalPowerComprehensiveClass$new(
        options = options,
        data = data)
