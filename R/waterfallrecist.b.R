    ...
    R6::R6Class(
        ...
        private = list(
            ...
            .renderInstructions = function() {
                ...
                html <- paste0(
                    "<div style='padding:12px; background-color: rgba(138, 172, 205, 0.06); color: inherit; ",
            ...
            .populateComplianceReport = function(target_validation, new_lesions, confirmed_responses) {
                ...
                html_content <- paste0(
                    ...
                    "<p style='padding: 10px; background-color: rgba(33, 33, 33, 0.07); color: inherit; border-left: 4px solid ",
