...
jviolinOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "jviolinOptions",
...
jviolinResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
jviolinBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "jviolinBase",
