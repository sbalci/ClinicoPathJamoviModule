...
survivalPowerOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "survivalPowerOptions",
...
survivalPowerResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    active = list(
        ...
        natural_language_summary = function() private$.items[["natural_language_summary"]],
        educational_explanations = function() private$.items[["educational_explanations"]],
        statistical_glossary = function() private$.items[["statistical_glossary"]],
        guided_workflow = function() private$.items[["guided_workflow"]]),
    private = list(),
    public=list(
...
#'   using Monte Carlo simulation. Available for fixed two-arm log-rank and Cox
#'   sample-size or power calculations under the exponential assumption.
#'   Multi-arm, cluster, interim-analysis and non-inferiority designs are not
#'   simulated. About 6 seconds at the default 2000 runs.
...
#'   \code{results$natural_language_summary} \tab \tab \tab \tab \tab a html \cr
#'   \code{results$educational_explanations} \tab \tab \tab \tab \tab a html \cr
#'   \code{results$statistical_glossary} \tab \tab \tab \tab \tab a html \cr
#'   \code{results$guided_workflow} \tab \tab \tab \tab \tab a html \cr
#' }
#'
