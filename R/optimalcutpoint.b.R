...
optimalcutpointClass <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        ...
        private = list(
            ...
            .interpretPPV = function(ppv) {
                ...
                if (ppv < 0.5) {
                    return("Poor positive prediction")
                }
                if (ppv < 0.7) {
                    return("Moderate positive prediction")
                }
                if (ppv < 0.9) {
                    return("Good positive prediction")
                }
            ...
            .interpretNPV = function(npv) {
                ...
                if (npv < 0.5) {
                    return("Poor negative prediction")
                }
                if (npv < 0.7) {
                    return("Moderate negative prediction")
                }
                if (npv < 0.9) {
                    return("Good negative prediction")
                }
            ...
            .interpretLR = function(lr, type) {
                ...
                if (type == "positive") {
                    if (lr < 2) {
                        return("Poor rule-in value")
                    }
                    if (lr < 5) {
                        return("Fair rule-in value")
                    }
                    if (lr < 10) {
                        return("Good rule-in value")
                    }
                    return("Excellent rule-in value")
                } else {
                    if (lr > 0.5) {
                        return("Poor rule-out value")
                    }
                    if (lr > 0.2) {
                        return("Fair rule-out value")
                    }
                    if (lr > 0.1) {
                        return("Good rule-out value")
                    }
