...
qualitycontrolOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "qualitycontrolOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(measurement_var = NULL,
                                  time_var = NULL,
                                  control_level = NULL,
                                  batch_var = NULL,
...
qualitycontrolResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
...
qualitycontrolBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "qualitycontrolBase",
