...
summarydata2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "summarydata2Options",
...
summarydata2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "summarydata2Results",
...
summarydata2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "summarydata2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = summarydata2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
summarydata2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("summarydata2 requires jmvcore to be installed (restart may be required)")
    ...
    options <- summarydata2Options$new(
        vars = vars,
        date_vars = date_vars,
        distr = distr,
    ...
    analysis <- summarydata2Class$new(
        options = options,
        data = data)
