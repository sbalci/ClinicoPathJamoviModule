...
crosstable2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "crosstable2Options",
...
crosstable2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "crosstable2Results",
...
crosstable2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "crosstable2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = crosstable2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
crosstable2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("crosstable2 requires jmvcore to be installed (restart may be required)")
    ...
    options <- crosstable2Options$new(
        vars = vars,
        group = group,
        sty = sty,
        excl = excl,
