...
ggoncoplotOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ggoncoplotOptions",
        ...
        initialize = function(
            ...
            private$..plotType <- jmvcore::OptionList$new(
                ...
                options=list(
                    ...
                    "cooccurrence"),
                default="oncoplot")
            private$..maxGenes <- jmvcore::OptionNumber$new(
                "maxGenes",
                maxGenes,
                default=20,
                min=5,
            ...
            self$.addOption(private$..maxGenes)
    ...
    active = list(
        ...
        maxGenes = function() private$..maxGenes$value,
...
ggoncoplotResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ggoncoplotResults",
...
ggoncoplotBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ggoncoplotBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,1),
                options = options,
                results = ggoncoplotResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' @param maxGenes Maximum number of genes to display (most frequently
#'   mutated).
...
ggoncoplot <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("ggoncoplot requires jmvcore to be installed (restart may be required)")
