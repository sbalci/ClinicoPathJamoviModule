    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Table$new(
                ...
                clearWith=list("x_var", "y_var", "fill_var"),
                columns=list(
                    `categories` = jmvcore::Column$new(
                        name="categories",
                        title="Categories",
                        type="integer"),
                    `segments` = jmvcore::Column$new(
                        name="segments",
                        title="Segments",
                        type="integer"),
                    `total_observations` = jmvcore::Column$new(
                        name="total_observations",
                        title="Total Observations",
                        type="integer"),
                    `chart_type` = jmvcore::Column$new(
                        name="chart_type",
                        title="Chart Type",
                        type="text"))))
            self$add(jmvcore::Table$new(
                ...
                clearWith=list("x_var", "y_var", "fill_var"),
                columns=list(
                    `category` = jmvcore::Column$new(
                        name="category",
                        title="Category",
                        type="text"),
                    `segment` = jmvcore::Column$new(
                        name="segment",
                        title="Segment",
                        type="text"),
                    `count` = jmvcore::Column$new(
                        name="count",
                        title="Count",
                        type="integer"),
                    `percentage` = jmvcore::Column$new(
                        name="percentage",
                        title="Percentage",
                        type="number",
                        format="pc"),
                    `total_in_category` = jmvcore::Column$new(
            ...
            self$add(jmvcore::Table$new(
                ...
                clearWith=list("x_var", "y_var", "fill_var"),
                columns=list(
                    `measure` = jmvcore::Column$new(
                        name="measure",
                        title="Measure",
                        type="text"),
                    `value` = jmvcore::Column$new(
                        name="value",
                        title="Value",
                        type="text"))))
            self$add(jmvcore::Html$new(
...
#' @param fill_var Categorical variable for bar segment colors and composition.
...
#' @return A results object containing the segmented total bar chart analysis results.
#' @export
