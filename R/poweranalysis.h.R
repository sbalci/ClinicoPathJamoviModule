...
poweranalysisOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
poweranalysisResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
poweranalysisBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "poweranalysisBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = poweranalysisResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
poweranalysis <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("poweranalysis requires jmvcore to be installed (restart may be required)")
    ...
    options <- poweranalysisOptions$new(
    ...
    analysis <- poweranalysisClass$new(
        options = options,
        data = data)
