groomecompareClass <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "groomecompareClass",
        ...
        private = list(
            ...
            .run = function() {
                ...
                summaryData <- data.frame(
                    ...
                    system1 = c(
                        metrics1$consistency, metrics1$discrimination,
                        metrics1$balance, metrics1$prediction, metrics1$overall
                    ),
                    system2 = c(
                        metrics2$consistency, metrics2$discrimination,
                ...
                private$.addNotice(
                    "INFO", paste0("Winner: ", winner),
                    paste0(
                        winner, " demonstrates superior performance (",
                ...
                if (self$options$cindexcompare) {
                    ...
                    if (is.null(cindex1) || is.null(cindex2)) {
                        ...
                        if (cindex_diff > 0.05) {
                            private$.addNotice(
                                "INFO", "C-Index Difference",
                                paste0(
                                    "C-index differs by ", round(cindex_diff, 3),
                ...
                private$.addNotice(
                    ...
                    paste0(
                        "Compared ", self$options$stage1name, " (", nlevels(stage1), " stages) vs. ",
            ...
            .plotRadar = function(image, ...) {
                ...
                values1 <- c(
                    state$metrics1$consistency, inv_disc1,
                    state$metrics1$balance, state$metrics1$prediction
                )
                values2 <- c(
                    state$metrics2$consistency, inv_disc2,
