    ...
    private = list(
        ...
        .populateMethodExplanation = function() {
            ...
            content <- paste0(
                ...
                "<p><strong>Coefficients (\u{03B2}):</strong> Log acceleration factors. A coefficient of \u{03B2} means:</p>",
                "<ul>",
                "<li>\u{03B2} > 0: Covariate accelerates failure (decreases survival time)</li>",
                "<li>\u{03B2} < 0: Covariate decelerates failure (increases survival time)</li>",
                "<li>\u{03B2} = 0: No effect on failure time</li>",
                "</ul>",
                
                "<p><strong>Acceleration Factors (exp(\u{03B2})):</strong> Multiplicative effects on survival time:</p>",
                "<ul>",
