...
multisurvival2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "multisurvival2Options",
...
multisurvival2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "multisurvival2Results",
...
multisurvival2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "multisurvival2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = multisurvival2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
multisurvival2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("multisurvival2 requires jmvcore to be installed (restart may be required)")
    ...
    options <- multisurvival2Options$new(
    ...
    analysis <- multisurvival2Class$new(
        options = options,
        data = data)
