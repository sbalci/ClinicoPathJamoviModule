...
alluvial2Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "alluvial2Options",
...
alluvial2Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "alluvial2Results",
...
alluvial2Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "alluvial2Base",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,0,3),
                options = options,
                results = alluvial2Results$new(options=options),
                data = data,
                datasetId = datasetId,
...
alluvial2 <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("alluvial2 requires jmvcore to be installed (restart may be required)")
