    ...
    R6::R6Class(
        ...
        private = list(
            ...
            .populateParameters = function() {
                if (is.null(private$.group_params)) {
                    return()
                }
            ...
            .formatTramResults = function(tram_fit, auc_results) {
                ...
                html <- paste0(
                    html, "<tr><td><b>Log-likelihood:</b></td><td>",
                    round(logLik(tram_fit), 2), "</td></tr>"
                )
                html <- paste0(
                    html, "<tr><td><b>AIC:</b></td><td>",
                    round(AIC(tram_fit), 2), "</td></tr>"
                )
                html <- paste0(
                    html, "<tr><td><b>BIC:</b></td><td>",
