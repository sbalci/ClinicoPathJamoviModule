...
phevalClass <- R6::R6Class(
    ...
    private = list(
        ...
        .populateIndividualTests = function(test_results) {
            if (!self$options$show_individual_tests) {
                return()
            }
        ...
        .populateGlobalTests = function(test_results) {
            if (!self$options$show_global_tests) {
                return()
            }
        ...
        .populateResidualAnalysis = function(test_results) {
            if (!self$options$show_individual_tests || is.null(test_results$residual_analysis)) {
                return()
            }
        ...
        .populateTimeVaryingPlots = function(test_results) {
            if (!self$options$show_time_varying_plots) {
                return()
            }
