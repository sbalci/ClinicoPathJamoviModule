...
jjwafflestatsOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjwafflestatsOptions",
...
jjwafflestatsResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjwafflestatsResults",
...
jjwafflestatsBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jjwafflestatsBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = jjwafflestatsResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' @param counts The numeric values to be represented in the waffle chart
...
jjwafflestats <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jjwafflestats requires jmvcore to be installed (restart may be required)")
    ...
    options <- jjwafflestatsOptions$new(
        counts = counts,
        groups = groups,
        facet = facet,
        rows = rows,
    ...
    analysis <- jjwafflestatsClass$new(
        options = options,
        data = data)
