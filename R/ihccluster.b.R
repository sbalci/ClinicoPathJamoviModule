    ...
    R6::R6Class(
        ...
        private = list(
                    ...
                    for (var in catVars) {
                        ...
                        if (is.factor(df[[var]])) {
                            ...
                            if (n_positive == 0 || n_negative == 0) {
                                conversion_info$warnings <- c(
                                    conversion_info$warnings,
                                    sprintf(
                                        "%s: All cases coded as %s", var,
            ...
            .clusterData = function(df, method, opts, k, autoSelect, catVars, contVars, weights, silhouetteTable = NULL) {
                result <- list(
                    clusters = NULL, usedK = k, fit = NULL, dist = NULL, hc = NULL,
                ...
                if (has_missing_data) {
                    ...
                    if (length(missing_cat) > 0) {
                        missing_parts <- c(
                            missing_parts,
                            sprintf(
                                "Categorical markers with missing values: %s",
                    ...
                    if (length(missing_cont) > 0) {
                        missing_parts <- c(
                            missing_parts,
                            sprintf(
                                "Continuous markers with missing values: %s",
                    ...
                    notice_text <- paste0(
                        sprintf(
                            "Missing data detected in %d marker(s) affecting %d case(s). ",
...
")
            ...
            .plotConsensus = function(image, ggtheme, theme, ...) {
                ...
                if (is.null(analysisState) || is.null(analysisState$consensusMatrix)) {
                    return(FALSE)
                }
            ...
            .plotSilhouette = function(image, ggtheme, theme, ...) {
                ...
                if (is.null(clusters) || is.null(dist_matrix)) {
                    return()
                }
            ...
            .plotHeatmap = function(image, ggtheme, theme, ...) {
                ...
                clusters <- analysisState$clusters
                df <- analysisState$df
                if (is.null(clusters) || is.null(df)) {
                    return()
                }
            ...
            .populatePCAContributions = function() {
                if (!isTRUE(self$options$showPCAPlot)) {
                    return()
                }
                ...
                if (is.null(dimredResult) || is.null(dimredResult$contributions)) {
                    return()
                }
            ...
            .plotPCA = function(image, ggtheme, theme, ...) {
                ...
                if (is.null(clusters) || is.null(df) || is.null(dimredResult)) {
                    return()
                }
            ...
            .plotMCA = function(image, ggtheme, theme, ...) {
                if (self$options$method != "mca_kmeans" && self$options$method != "dimreduce") {
                    return()
                }
            ...
            .plotBoxplots = function(image, ggtheme, theme, ...) {
                ...
                if (is.null(clusters) || is.null(df) || length(contVars) == 0) {
                    return()
                }
            ...
            .plotMarkerCorrelation = function(image, ggtheme, theme, ...) {
                if (!isTRUE(self$options$showMarkerCorrelation)) {
                    return()
                }
            ...
            .performIterativeRefinement = function(df, catVars, contVars, max_iterations = 3) {
                if (!isTRUE(self$options$iterativeRefinement)) {
                    return(NULL)
                }
                ...
                for (iter in 1:max_iterations) {
                    ...
                    importance <- private$.computeMarkerImportance(
                        df_subset, clusters,
            ...
            .populateMarkerImportance = function() {
                if (!isTRUE(self$options$markerOptimization)) {
                    return()
                }
                            ...
                            result <- tryCatch(
                                {
                                    ...
                                    # Interpretation
                                    r <- abs(test$estimate)
                                    interp <- if (test$p.value < 0.05 && r > 0.7) {
                                        "Strong correlation"
                                    } else if (test$p.value < 0.05 && r > 0.4) {
            ...
            .populateMarkerClusteringResults = function() {
                if (!isTRUE(self$options$performMarkerClustering)) {
                    return()
                }
            ...
            .plotMarkerDendrogram = function(image, ggtheme, theme, ...) {
                ...
                plot(hc,
                    main = sprintf(
                        "Marker Clustering Dendrogram (%s distance, %s linkage)",
            ...
            .populateClusterQuality = function() {
                if (!isTRUE(self$options$clusterQualityMetrics)) {
                    return()
                }
            ...
            .populateRefinementHistory = function() {
                ...
                if (is.null(refinement) || is.null(refinement$history)) {
                    return()
                }
            ...
            .populateSpatialCompartmentSummary = function() {
                if (!isTRUE(self$options$performSpatialAnalysis)) {
                    return()
                }
                ...
                spatialResults <- analysisState$spatialResults
                if (is.null(spatialResults) || is.null(spatialResults$compartment_summary)) {
                    return()
                }
            ...
            .populateMarkerPerformance = function() {
                if (!isTRUE(self$options$calculateDiagnosticMetrics)) {
                    return()
                }
                if (is.null(self$options$knownDiagnosis)) {
                    return()
                }
            ...
            .populateOptimalPanels = function() {
                if (!isTRUE(self$options$identifyOptimalPanel)) {
                    return()
                }
                if (is.null(self$options$knownDiagnosis)) {
                    return()
            ...
            .populateOutlierCases = function() {
                if (!isTRUE(self$options$flagOutliers)) {
                    return()
                }
            ...
            .populateReproducibilityStats = function(reproducibilityResults) {
                if (!isTRUE(self$options$reproducibilityTest)) {
                    return()
                }
                if (is.null(reproducibilityResults)) {
                    return()
                }
            ...
            .populateSupervisedResults = function(supervisedResults) {
                if (!isTRUE(self$options$supervisedClustering)) {
                    return()
                }
                if (is.null(supervisedResults)) {
                    return()
                }
            ...
            .populateRatioResults = function(ratioResult) {
                if (!isTRUE(self$options$calculateRatios)) {
                    return()
                }
                if (is.null(ratioResult)) {
                    return()
                }
                ...
                if (isTRUE(self$options$ratioClassification) && !is.null(ratioResult$classification)) {
                    ...
                    if (!is.null(classTable)) {
                        ...
                        note_text <- sprintf(
                            "Classification: Low (<= %.2f), Intermediate (> %.2f and < %.2f), High (>= %.2f)",
