...
true_gleason <- sample(gleason_scores, n_cases_prostate,
  replace = TRUE,
...
true_breslow <- sample(breslow_categories, n_cases_melanoma,
  replace = TRUE,
...
true_bethesda <- sample(bethesda_categories, n_cases_thyroid,
  replace = TRUE,
...
true_lung <- sample(lung_subtypes, n_cases_lung,
  replace = TRUE,
