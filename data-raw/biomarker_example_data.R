...
psa_longitudinal_data <- data.frame(
  ...
  gleason_score = rep(factor(sample(c("6", "7", "8", "9", "10"), 100,
    replace = TRUE, prob = c(0.1, 0.4, 0.3, 0.15, 0.05)
  )), each = 8),
  ...
  clinical_response = rep(factor(sample(
    c(
