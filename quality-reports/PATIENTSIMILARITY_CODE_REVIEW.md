...
1. **Negative values in non-negative biomarkers:**
...
1. **Fix Silent Failures** (estimated: 2 hours)
...
1. **Beck AH, et al.** (2011). Systematic analysis of breast cancer morphology uncovers stromal features associated with survival. *Science Translational Medicine* 3(108):108ra113.
2. **Saltz J, et al.** (2018). Spatial organization and molecular correlation of tumor-infiltrating lymphocytes using deep learning on pathology images. *Cell Reports* 23(1):181-193.

### Implementation References

1. **Orange Data Mining** - Projection widget documentation: <https://orangedatamining.com/widget-catalog/unsupervised/>
2. **jamovi Development Guide** - `vignettes/jamovi_module_patterns_guide.md`
3. **jamovi Notices Guide** - `vignettes/jamovi_notices_guide.md`
