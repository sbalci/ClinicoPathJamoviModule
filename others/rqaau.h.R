...
rqaAUOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "rqaAUOptions",
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Table$new(
                options=options,
                name="tblRQA",
                title="RQA measures based on line structures",
                rows=3,
                clearWith=list(
                    "y1",
                    "emRad",
...
rqaAUBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "rqaAUBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = rqaAUResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#'   \code{results$tblRQA} \tab \tab \tab \tab \tab a table \cr
...
rqaAU <- function(
    ...
    if ( ! requireNamespace('jmvcore'))
        stop('rqaAU requires jmvcore to be installed (restart may be required)')
