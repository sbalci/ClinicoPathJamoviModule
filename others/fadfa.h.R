...
faDFAOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "faDFAOptions",
        ...
        initialize = function(
            ...
            private$..removeTrend <- jmvcore::OptionList$new(
                ...
                options=list(
                    ...
                    "adapt"),
                default="poly")
            private$..poly_order <- jmvcore::OptionNumber$new(
                "poly_order",
                poly_order,
                default=1)
            private$..max_order <- jmvcore::OptionNumber$new(
                "max_order",
                max_order,
                default=5)
            ...
            self$.addOption(private$..poly_order)
            self$.addOption(private$..max_order)
    ...
    active = list(
        ...
        poly_order = function() private$..poly_order$value,
        max_order = function() private$..max_order$value,
...
faDFAResults <- if (requireNamespace('jmvcore')) R6::R6Class(
    inherit = jmvcore::Group,
    active = list(
        tblTS = function() private$.items[["tblTS"]],
        tblDFA = function() private$.items[["tblDFA"]],
        tsplot = function() private$.items[["tsplot"]],
        dfaplot = function() private$.items[["dfaplot"]]),
    private = list(),
    public=list(
...
faDFABase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "faDFABase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = faDFAResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#'   \code{results$tblDFA} \tab \tab \tab \tab \tab a table \cr
#'   \code{results$tsplot} \tab \tab \tab \tab \tab an image \cr
#'   \code{results$dfaplot} \tab \tab \tab \tab \tab an image \cr
#' }
#'
