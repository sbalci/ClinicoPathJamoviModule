# Internationalization (i18n) Translation Plan: kappaSizeFixedN → Turkish (TR)

## 0) Argument Normalization

**SANITIZED_FN**: `kappaSizeFixedN`

**Target files analysis**:
- ✅ `jamovi/kappaSizeFixedN.a.yaml` (options)
- ✅ `jamovi/kappaSizeFixedN.u.yaml` (UI)
- ✅ `jamovi/kappaSizeFixedN.r.yaml` (results)
- ✅ `R/kappaSizeFixedN.b.R` (backend)
...
- ✅ All user-visible strings in `R/kappaSizeFixedN.b.R` and YAML definitions are wrapped in `.(...)` or declared in schemas.
...
| :--- | :--- | :--- |
| `Lowest Expected Value for a fixed sample size` | `Sabit Örneklem Boyutu için En Düşük Beklenen Değer` | Başlık |
...
- [x] User-facing strings in `R/kappaSizeFixedN.b.R` properly wrapped in `.(...)`.
