...
An `R6` class generator object for the `jjscatterstatsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjscatterstatsBase` -\> `jjscatterstatsClass`

## Methods

### Public methods

- [`jjscatterstatsClass$asSource()`](#method-jjscatterstatsClass-asSource)

- [`jjscatterstatsClass$clone()`](#method-jjscatterstatsClass-clone)
...
- `jjscatterstatsBase$initialize()`

------------------------------------------------------------------------

### `jjscatterstatsClass$asSource()`
