...
R6 class for performing contingency table analysis.

## Value

An `R6` class generator object for the `contTablesClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`contTablesBase` -\> `contTablesClass`

## Methods

### Public methods

- [`contTablesClass$asSource()`](#method-contTablesClass-asSource)

- [`contTablesClass$clone()`](#method-contTablesClass-clone)
...
- `contTablesBase$initialize()`

------------------------------------------------------------------------

### `contTablesClass$asSource()`
...
### `contTablesClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    contTablesClass$clone(deep = FALSE)
