...
An `R6` class generator object for the `studydiagramClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`studydiagramBase` -\> `studydiagramClass`

## Methods

### Public methods

- [`studydiagramClass$clone()`](#method-studydiagramClass-clone)
...
- `studydiagramBase$initialize()`

------------------------------------------------------------------------

### `studydiagramClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    studydiagramClass$clone(deep = FALSE)
