...
An `R6` class generator object for the `raftgeeClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`raftgeeBase` -\> `raftgeeClass`

## Methods

### Public methods

- [`raftgeeClass$clone()`](#method-raftgeeClass-clone)
