...
An `R6` class generator object for the `mixedeffectscoxClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`mixedeffectscoxBase` -\> `mixedeffectscoxClass`

## Methods

### Public methods

- [`mixedeffectscoxClass$clone()`](#method-mixedeffectscoxClass-clone)
...
- `mixedeffectscoxBase$initialize()`

------------------------------------------------------------------------

### `mixedeffectscoxClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    mixedeffectscoxClass$clone(deep = FALSE)
