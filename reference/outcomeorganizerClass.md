...
An `R6` class generator object for the `outcomeorganizerClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`outcomeorganizerBase` -\> `outcomeorganizerClass`

## Methods

### Public methods

- [`outcomeorganizerClass$clone()`](#method-outcomeorganizerClass-clone)
...
- `outcomeorganizerBase$initialize()`

------------------------------------------------------------------------

### `outcomeorganizerClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    outcomeorganizerClass$clone(deep = FALSE)
