...
A results object containing HTML-formatted text summaries and visual
tables

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`reportcat2Base` -\> `reportcat2Class`

## Methods

### Public methods

- [`reportcat2Class$clone()`](#method-reportcat2Class-clone)
...
- `reportcat2Base$initialize()`

------------------------------------------------------------------------

### `reportcat2Class$clone()`

The objects of this class are cloneable with this method.

#### Usage

    reportcat2Class$clone(deep = FALSE)
...
#> Error in reportcat(data = data, vars = "treatment", sumvar_style = TRUE,     show_proportions = TRUE): unused arguments (sumvar_style = TRUE, show_proportions = TRUE)
...
#> Error in reportcat(data = data, vars = "grade", sort_by_frequency = TRUE): unused argument (sort_by_frequency = TRUE)
# }
```
