...
An `R6` class generator object for the `decisioncompareClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`decisioncompareBase` -\> `decisioncompareClass`

## Methods

### Public methods

- [`decisioncompareClass$clone()`](#method-decisioncompareClass-clone)
...
- `decisioncompareBase$initialize()`

------------------------------------------------------------------------

### `decisioncompareClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    decisioncompareClass$clone(deep = FALSE)
