...
An `R6` class generator object for the `jjtreemapClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjtreemapBase` -\> `jjtreemapClass`

## Methods

### Public methods

- [`jjtreemapClass$clone()`](#method-jjtreemapClass-clone)
...
- `jjtreemapBase$initialize()`

------------------------------------------------------------------------

### `jjtreemapClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjtreemapClass$clone(deep = FALSE)
