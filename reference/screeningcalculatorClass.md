...
An `R6` class generator object for the `screeningcalculatorClass`
...
`screeningcalculatorBase` -\> `screeningcalculatorClass`

## Methods

### Public methods

- [`screeningcalculatorClass$clone()`](#method-screeningcalculatorClass-clone)
...
- `screeningcalculatorBase$initialize()`

------------------------------------------------------------------------

### `screeningcalculatorClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    screeningcalculatorClass$clone(deep = FALSE)
