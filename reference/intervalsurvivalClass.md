...
An `R6` class generator object for the `intervalsurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`intervalsurvivalBase` -\> `intervalsurvivalClass`

## Active bindings

- `.current_model`:

  Active binding for storing the current model object

## Methods

### Public methods

- [`intervalsurvivalClass$clone()`](#method-intervalsurvivalClass-clone)
...
- `intervalsurvivalBase$initialize()`

------------------------------------------------------------------------

### `intervalsurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    intervalsurvivalClass$clone(deep = FALSE)
