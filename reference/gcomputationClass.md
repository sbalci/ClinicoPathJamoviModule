...
`gcomputationBase` -\> `gcomputationClass`

## Methods

### Public methods

- [`gcomputationClass$clone()`](#method-gcomputationClass-clone)
...
- `gcomputationBase$initialize()`

------------------------------------------------------------------------

### `gcomputationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    gcomputationClass$clone(deep = FALSE)
