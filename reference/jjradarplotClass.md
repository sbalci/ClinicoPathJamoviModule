...
An `R6` class generator object for the `jjradarplotClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjradarplotBase` -\> `jjradarplotClass`

## Methods

### Public methods

- [`jjradarplotClass$clone()`](#method-jjradarplotClass-clone)
...
- `jjradarplotBase$initialize()`

------------------------------------------------------------------------

### `jjradarplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjradarplotClass$clone(deep = FALSE)
