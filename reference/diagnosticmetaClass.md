...
An `R6` class generator object for the `diagnosticmetaClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`diagnosticmetaBase` -\> `diagnosticmetaClass`

## Methods

### Public methods

- [`diagnosticmetaClass$clone()`](#method-diagnosticmetaClass-clone)
...
- `diagnosticmetaBase$initialize()`

------------------------------------------------------------------------

### `diagnosticmetaClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    diagnosticmetaClass$clone(deep = FALSE)
