...
An `R6` class generator object for the `polychoriccorrClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`polychoriccorrBase` -\> `polychoriccorrClass`

## Methods

### Public methods

- [`polychoriccorrClass$clone()`](#method-polychoriccorrClass-clone)
...
- `polychoriccorrBase$initialize()`

------------------------------------------------------------------------

### `polychoriccorrClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    polychoriccorrClass$clone(deep = FALSE)
