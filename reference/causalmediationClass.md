...
An `R6` class generator object for the `causalmediationClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`causalmediationBase` -\> `causalmediationClass`

## Methods

### Public methods

- [`causalmediationClass$clone()`](#method-causalmediationClass-clone)
...
- `causalmediationBase$initialize()`

------------------------------------------------------------------------

### `causalmediationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    causalmediationClass$clone(deep = FALSE)
