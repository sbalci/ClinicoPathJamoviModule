...
Lachin-Foulkes and Schoenfeld methods from the gsDesign package. This
module provides comprehensive power calculations for clinical trials
with time-to-event endpoints.

## Value

Power analysis results with sample size, number of events, and study
design parameters.

## Details

This module implements the functionality requested in GitHub Issue \#72,
providing comprehensive power analysis capabilities for survival
studies. Two main methods are supported:
...
`classicalSurvivalPowerBase` -\> `classicalSurvivalPowerClass`

## Methods

### Public methods

- [`classicalSurvivalPowerClass$clone()`](#method-classicalSurvivalPowerClass-clone)
...
- `classicalSurvivalPowerBase$initialize()`

------------------------------------------------------------------------

### `classicalSurvivalPowerClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    classicalSurvivalPowerClass$clone(deep = FALSE)
