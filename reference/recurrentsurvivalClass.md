...
An `R6` class generator object for the `recurrentsurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`recurrentsurvivalBase` -\> `recurrentsurvivalClass`

## Active bindings

- `.current_model`:

  The currently fitted recurrent event model

## Methods

### Public methods

- [`recurrentsurvivalClass$clone()`](#method-recurrentsurvivalClass-clone)
...
- `recurrentsurvivalBase$initialize()`

------------------------------------------------------------------------

### `recurrentsurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    recurrentsurvivalClass$clone(deep = FALSE)
