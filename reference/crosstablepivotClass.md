...
Creates professional cross tables using pivottabler library for flexible
...
`crosstablepivotBase` -\> `crosstablepivotClass`

## Methods

### Public methods

- [`crosstablepivotClass$clone()`](#method-crosstablepivotClass-clone)
...
- `crosstablepivotBase$initialize()`

------------------------------------------------------------------------

### `crosstablepivotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    crosstablepivotClass$clone(deep = FALSE)
