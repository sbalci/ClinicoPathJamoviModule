...
`clinicalnomogramsBase` -\> `clinicalnomogramsClass`

## Methods

### Public methods

- [`clinicalnomogramsClass$clone()`](#method-clinicalnomogramsClass-clone)
...
- `clinicalnomogramsBase$initialize()`

------------------------------------------------------------------------

### `clinicalnomogramsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    clinicalnomogramsClass$clone(deep = FALSE)
