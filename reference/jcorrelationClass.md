...
An `R6` class generator object for the `jcorrelationClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jcorrelationBase` -\> `jcorrelationClass`

## Methods

### Public methods

- [`jcorrelationClass$asSource()`](#method-jcorrelationClass-asSource)

- [`jcorrelationClass$clone()`](#method-jcorrelationClass-clone)
...
- `jcorrelationBase$initialize()`

------------------------------------------------------------------------

### `jcorrelationClass$asSource()`
...
### `jcorrelationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jcorrelationClass$clone(deep = FALSE)
