...
An `R6` class generator object for the `gradientboostingClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`gradientboostingBase` -\> `gradientboostingClass`

## Methods

### Public methods

- [`gradientboostingClass$clone()`](#method-gradientboostingClass-clone)
...
- `gradientboostingBase$initialize()`

------------------------------------------------------------------------

### `gradientboostingClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    gradientboostingClass$clone(deep = FALSE)
