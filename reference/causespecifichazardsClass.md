...
An `R6` class generator object for the `causespecifichazardsClass`
...
`causespecifichazardsBase` -\> `causespecifichazardsClass`

## Methods

### Public methods

- [`causespecifichazardsClass$clone()`](#method-causespecifichazardsClass-clone)
...
- `causespecifichazardsBase$initialize()`

------------------------------------------------------------------------

### `causespecifichazardsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    causespecifichazardsClass$clone(deep = FALSE)
