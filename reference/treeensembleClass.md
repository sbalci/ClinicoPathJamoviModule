...
Random Forest ensemble methods for clinical research and biomarker
discovery

## Value

An `R6` class generator object for the `treeensembleClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`treeensembleBase` -\> `treeensembleClass`

## Methods

### Public methods

- [`treeensembleClass$clone()`](#method-treeensembleClass-clone)
...
- `treeensembleBase$initialize()`

------------------------------------------------------------------------

### `treeensembleClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treeensembleClass$clone(deep = FALSE)
