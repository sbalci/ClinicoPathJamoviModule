...
An `R6` class generator object for the `ihcbasicClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`ihcbasicBase` -\> `ihcbasicClass`

## Methods

### Public methods

- [`ihcbasicClass$clone()`](#method-ihcbasicClass-clone)
...
#### Usage
    ...
    ihcbasicClass$clone(deep = FALSE)
