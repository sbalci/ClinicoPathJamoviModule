...
Creates advanced ridgeline plots with robust statistical analysis

## Value

An `R6` class generator object for the `jjridgesClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjridgesBase` -\> `jjridgesClass`

## Methods

### Public methods

- [`jjridgesClass$asSource()`](#method-jjridgesClass-asSource)

- [`jjridgesClass$clone()`](#method-jjridgesClass-clone)
...
- `jjridgesBase$initialize()`

------------------------------------------------------------------------

### `jjridgesClass$asSource()`
...
#### Usage
    ...
    jjridgesClass$clone(deep = FALSE)
