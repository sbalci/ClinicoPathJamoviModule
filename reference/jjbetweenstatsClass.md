...
An `R6` class generator object for the `jjbetweenstatsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjbetweenstatsBase` -\> `jjbetweenstatsClass`

## Methods

### Public methods

- [`jjbetweenstatsClass$asSource()`](#method-jjbetweenstatsClass-asSource)

- [`jjbetweenstatsClass$clone()`](#method-jjbetweenstatsClass-clone)
...
- `jjbetweenstatsBase$initialize()`

------------------------------------------------------------------------

### `jjbetweenstatsClass$asSource()`
