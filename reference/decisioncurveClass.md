...
An `R6` class generator object for the `decisioncurveClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`decisioncurveBase` -\> `decisioncurveClass`

## Methods

### Public methods

- [`decisioncurveClass$clone()`](#method-decisioncurveClass-clone)
...
- `decisioncurveBase$initialize()`

------------------------------------------------------------------------

### `decisioncurveClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    decisioncurveClass$clone(deep = FALSE)
