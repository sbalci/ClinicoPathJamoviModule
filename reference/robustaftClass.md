...
An `R6` class generator object for the `robustaftClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`robustaftBase` -\> `robustaftClass`

## Methods

### Public methods

- [`robustaftClass$clone()`](#method-robustaftClass-clone)
...
- `robustaftBase$initialize()`

------------------------------------------------------------------------

### `robustaftClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    robustaftClass$clone(deep = FALSE)
