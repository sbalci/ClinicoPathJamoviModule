...
An `R6` class generator object for the `assayoptimizationClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`assayoptimizationBase` -\> `assayoptimizationClass`

## Methods

### Public methods

- [`assayoptimizationClass$clone()`](#method-assayoptimizationClass-clone)
...
- `assayoptimizationBase$initialize()`

------------------------------------------------------------------------

### `assayoptimizationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    assayoptimizationClass$clone(deep = FALSE)
