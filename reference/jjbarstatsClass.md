...
An `R6` class generator object for the `jjbarstatsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjbarstatsBase` -\> `jjbarstatsClass`

## Methods

### Public methods

- [`jjbarstatsClass$asSource()`](#method-jjbarstatsClass-asSource)

- [`jjbarstatsClass$clone()`](#method-jjbarstatsClass-clone)
...
- `jjbarstatsBase$initialize()`

------------------------------------------------------------------------

### `jjbarstatsClass$asSource()`
