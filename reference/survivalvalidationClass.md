...
An `R6` class generator object for the `survivalvalidationClass`
...
`survivalvalidationBase` -\> `survivalvalidationClass`

## Methods

### Public methods

- [`survivalvalidationClass$clone()`](#method-survivalvalidationClass-clone)
...
- `survivalvalidationBase$initialize()`

------------------------------------------------------------------------

### `survivalvalidationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    survivalvalidationClass$clone(deep = FALSE)
