...
An `R6` class generator object for the `treatmentSwitchingClass`
...
`treatmentswitchingBase` -\> `treatmentSwitchingClass`

## Methods

### Public methods

- [`treatmentSwitchingClass$clone()`](#method-treatmentSwitchingClass-clone)
...
- `treatmentswitchingBase$initialize()`

------------------------------------------------------------------------

### `treatmentSwitchingClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treatmentSwitchingClass$clone(deep = FALSE)
