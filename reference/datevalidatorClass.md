...
Validated and quality-checked date/datetime fields using multiple
packages

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`datevalidatorBase` -\> `datevalidatorClass`

## Methods

### Public methods

- [`datevalidatorClass$clone()`](#method-datevalidatorClass-clone)
...
- `datevalidatorBase$initialize()`

------------------------------------------------------------------------

### `datevalidatorClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    datevalidatorClass$clone(deep = FALSE)
