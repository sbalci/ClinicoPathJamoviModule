...
An `R6` class generator object for the `pseudosurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`pseudosurvivalBase` -\> `pseudosurvivalClass`

## Methods

### Public methods

- [`pseudosurvivalClass$clone()`](#method-pseudosurvivalClass-clone)
...
- `pseudosurvivalBase$initialize()`

------------------------------------------------------------------------

### `pseudosurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pseudosurvivalClass$clone(deep = FALSE)
