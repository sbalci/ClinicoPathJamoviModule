...
An `R6` class generator object for the `jjdotchartClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjdotchartBase` -\> `jjdotchartClass`

## Methods

### Public methods

- [`jjdotchartClass$clone()`](#method-jjdotchartClass-clone)
...
- `jjdotchartBase$initialize()`

------------------------------------------------------------------------

### `jjdotchartClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjdotchartClass$clone(deep = FALSE)
