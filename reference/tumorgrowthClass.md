...
An `R6` class generator object for the `tumorgrowthClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`tumorgrowthBase` -\> `tumorgrowthClass`

## Methods

### Public methods

- [`tumorgrowthClass$clone()`](#method-tumorgrowthClass-clone)
...
- `tumorgrowthBase$initialize()`

------------------------------------------------------------------------

### `tumorgrowthClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    tumorgrowthClass$clone(deep = FALSE)
