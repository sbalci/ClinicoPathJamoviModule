...
An `R6` class generator object for the `friedmantestClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`friedmantestBase` -\> `friedmantestClass`

## Methods

### Public methods

- [`friedmantestClass$clone()`](#method-friedmantestClass-clone)
...
- `friedmantestBase$initialize()`

------------------------------------------------------------------------

### `friedmantestClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    friedmantestClass$clone(deep = FALSE)
