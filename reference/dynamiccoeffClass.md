...
An `R6` class generator object for the `dynamiccoeffClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`dynamiccoeffBase` -\> `dynamiccoeffClass`

## Methods

### Public methods

- [`dynamiccoeffClass$clone()`](#method-dynamiccoeffClass-clone)
...
- `dynamiccoeffBase$initialize()`

------------------------------------------------------------------------

### `dynamiccoeffClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    dynamiccoeffClass$clone(deep = FALSE)
