...
An `R6` class generator object for the `comprehensiveSurvivalPowerClass`
...
`comprehensiveSurvivalPowerBase` -\> `comprehensiveSurvivalPowerClass`

## Methods

### Public methods

- [`comprehensiveSurvivalPowerClass$clone()`](#method-comprehensiveSurvivalPowerClass-clone)
...
- `comprehensiveSurvivalPowerBase$initialize()`

------------------------------------------------------------------------

### `comprehensiveSurvivalPowerClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    comprehensiveSurvivalPowerClass$clone(deep = FALSE)
