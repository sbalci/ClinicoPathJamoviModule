...
An `R6` class generator object for the `advancedtrialsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`advancedtrialsBase` -\> `advancedtrialsClass`

## Methods

### Public methods

- [`advancedtrialsClass$clone()`](#method-advancedtrialsClass-clone)
...
- `advancedtrialsBase$initialize()`

------------------------------------------------------------------------

### `advancedtrialsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    advancedtrialsClass$clone(deep = FALSE)
