...
An `R6` class generator object for the `survivalendpointsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`survivalendpointsBase` -\> `survivalendpointsClass`

## Methods

### Public methods

- [`survivalendpointsClass$clone()`](#method-survivalendpointsClass-clone)
...
- `survivalendpointsBase$initialize()`

------------------------------------------------------------------------

### `survivalendpointsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    survivalendpointsClass$clone(deep = FALSE)
