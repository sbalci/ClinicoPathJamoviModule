...
`residualcancerburdenBase` -\> `residualcancerburdenClass`

## Methods

### Public methods

- [`residualcancerburdenClass$clone()`](#method-residualcancerburdenClass-clone)
...
- `residualcancerburdenBase$initialize()`

------------------------------------------------------------------------

### `residualcancerburdenClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    residualcancerburdenClass$clone(deep = FALSE)
