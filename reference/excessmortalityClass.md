...
An `R6` class generator object for the `excessmortalityClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`excessmortalityBase` -\> `excessmortalityClass`

## Methods

### Public methods

- [`excessmortalityClass$clone()`](#method-excessmortalityClass-clone)
...
- `excessmortalityBase$initialize()`

------------------------------------------------------------------------

### `excessmortalityClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    excessmortalityClass$clone(deep = FALSE)
