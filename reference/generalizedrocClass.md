...
An `R6` class generator object for the `generalizedrocClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`generalizedrocBase` -\> `generalizedrocClass`

## Methods

### Public methods

- [`generalizedrocClass$clone()`](#method-generalizedrocClass-clone)
...
- `generalizedrocBase$initialize()`

------------------------------------------------------------------------

### `generalizedrocClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    generalizedrocClass$clone(deep = FALSE)
