...
An `R6` class generator object for the `irecistClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`irecistBase` -\> `irecistClass`

## Methods

### Public methods

- [`irecistClass$clone()`](#method-irecistClass-clone)
