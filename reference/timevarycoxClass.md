# Time-Varying Covariates Cox Regression Implementation

Backend implementation class for Cox proportional hazards regression
with time-varying covariates. This R6 class provides comprehensive
...
`timevarycoxBase` -\> `timevarycoxClass`

## Methods

### Public methods

- [`timevarycoxClass$clone()`](#method-timevarycoxClass-clone)
...
- `timevarycoxBase$initialize()`

------------------------------------------------------------------------

### `timevarycoxClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    timevarycoxClass$clone(deep = FALSE)
