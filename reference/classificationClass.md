...
An `R6` class generator object for the `classificationClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`classificationBase` -\> `classificationClass`

## Methods

### Public methods

- [`classificationClass$clone()`](#method-classificationClass-clone)
...
### `classificationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    classificationClass$clone(deep = FALSE)
