...
An `R6` class generator object for the `jjcorrmatClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjcorrmatBase` -\> `jjcorrmatClass`

## Methods

### Public methods

- [`jjcorrmatClass$asSource()`](#method-jjcorrmatClass-asSource)

- [`jjcorrmatClass$clone()`](#method-jjcorrmatClass-clone)
...
- `jjcorrmatBase$initialize()`

------------------------------------------------------------------------

### `jjcorrmatClass$asSource()`
