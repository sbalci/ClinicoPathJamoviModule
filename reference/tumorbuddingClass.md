...
`tumorbuddingBase` -\> `tumorbuddingClass`

## Methods

### Public methods

- [`tumorbuddingClass$clone()`](#method-tumorbuddingClass-clone)
...
- `tumorbuddingBase$initialize()`

------------------------------------------------------------------------

### `tumorbuddingClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    tumorbuddingClass$clone(deep = FALSE)
