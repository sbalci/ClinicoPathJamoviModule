...
An `R6` class generator object for the `jointfrailtyClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jointfrailtyBase` -\> `jointfrailtyClass`

## Methods

### Public methods

- [`jointfrailtyClass$clone()`](#method-jointfrailtyClass-clone)
...
- `jointfrailtyBase$initialize()`

------------------------------------------------------------------------

### `jointfrailtyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jointfrailtyClass$clone(deep = FALSE)
