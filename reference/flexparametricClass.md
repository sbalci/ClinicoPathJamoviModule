...
An `R6` class generator object for the `flexparametricClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`flexparametricBase` -\> `flexparametricClass`

## Methods

### Public methods

- [`flexparametricClass$clone()`](#method-flexparametricClass-clone)
...
- `flexparametricBase$initialize()`

------------------------------------------------------------------------

### `flexparametricClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    flexparametricClass$clone(deep = FALSE)
