...
An `R6` class generator object for the `reclassmetricsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`reclassmetricsBase` -\> `reclassmetricsClass`

## Methods

### Public methods

- [`reclassmetricsClass$clone()`](#method-reclassmetricsClass-clone)
...
- `reclassmetricsBase$initialize()`

------------------------------------------------------------------------

### `reclassmetricsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    reclassmetricsClass$clone(deep = FALSE)
