...
An `R6` class generator object for the `esquisseautoClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`esquisseautoBase` -\> `esquisseautoClass`

## Methods

### Public methods

- [`esquisseautoClass$clone()`](#method-esquisseautoClass-clone)
...
- `esquisseautoBase$initialize()`

------------------------------------------------------------------------

### `esquisseautoClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    esquisseautoClass$clone(deep = FALSE)
