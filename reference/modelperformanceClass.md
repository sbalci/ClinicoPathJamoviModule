...
`modelperformanceBase` -\> `modelperformanceClass`

## Methods

### Public methods

- [`modelperformanceClass$clone()`](#method-modelperformanceClass-clone)
...
- `modelperformanceBase$initialize()`

------------------------------------------------------------------------

### `modelperformanceClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    modelperformanceClass$clone(deep = FALSE)
