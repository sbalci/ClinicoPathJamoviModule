...
An `R6` class generator object for the `qualityoflifeClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`qualityoflifeBase` -\> `qualityoflifeClass`

## Methods

### Public methods

- [`qualityoflifeClass$clone()`](#method-qualityoflifeClass-clone)
...
- `qualityoflifeBase$initialize()`

------------------------------------------------------------------------

### `qualityoflifeClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    qualityoflifeClass$clone(deep = FALSE)
