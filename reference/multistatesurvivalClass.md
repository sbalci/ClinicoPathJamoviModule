...
An `R6` class generator object for the `multistatesurvivalClass`
...
`multistatesurvivalBase` -\> `multistatesurvivalClass`

## Methods

### Public methods

- [`multistatesurvivalClass$clone()`](#method-multistatesurvivalClass-clone)
...
- `multistatesurvivalBase$initialize()`

------------------------------------------------------------------------

### `multistatesurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    multistatesurvivalClass$clone(deep = FALSE)
