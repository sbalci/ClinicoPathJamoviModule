...
R6 class for performing pathology agreement analysis.

## Value

An `R6` class generator object for the `pathologyagreementClass`
...
`pathologyagreementBase` -\> `pathologyagreementClass`

## Methods

### Public methods

- [`pathologyagreementClass$asSource()`](#method-pathologyagreementClass-asSource)

- [`pathologyagreementClass$clone()`](#method-pathologyagreementClass-clone)
...
- `pathologyagreementBase$initialize()`

------------------------------------------------------------------------

### `pathologyagreementClass$asSource()`
...
### `pathologyagreementClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pathologyagreementClass$clone(deep = FALSE)
