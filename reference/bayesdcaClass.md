...
Tables and plots for decision curve analysis

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`bayesdcaBase` -\> `bayesdcaClass`

## Methods

### Public methods

- [`bayesdcaClass$clone()`](#method-bayesdcaClass-clone)
...
#### Usage
    ...
    bayesdcaClass$clone(deep = FALSE)
