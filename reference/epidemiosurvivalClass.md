...
An `R6` class generator object for the `epidemiosurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`epidemiosurvivalBase` -\> `epidemiosurvivalClass`

## Methods

### Public methods

- [`epidemiosurvivalClass$clone()`](#method-epidemiosurvivalClass-clone)
...
- `epidemiosurvivalBase$initialize()`

------------------------------------------------------------------------

### `epidemiosurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    epidemiosurvivalClass$clone(deep = FALSE)
