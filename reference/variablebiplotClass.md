...
An `R6` class generator object for the `variablebiplotClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`variablebiplotBase` -\> `variablebiplotClass`

## Methods

### Public methods

- [`variablebiplotClass$clone()`](#method-variablebiplotClass-clone)
...
- `variablebiplotBase$initialize()`

------------------------------------------------------------------------

### `variablebiplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    variablebiplotClass$clone(deep = FALSE)
