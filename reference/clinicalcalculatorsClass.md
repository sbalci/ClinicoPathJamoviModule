...
An `R6` class generator object for the `clinicalcalculatorsClass`
...
`clinicalcalculatorsBase` -\> `clinicalcalculatorsClass`

## Methods

### Public methods

- [`clinicalcalculatorsClass$clone()`](#method-clinicalcalculatorsClass-clone)
...
- `clinicalcalculatorsBase$initialize()`

------------------------------------------------------------------------

### `clinicalcalculatorsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    clinicalcalculatorsClass$clone(deep = FALSE)
