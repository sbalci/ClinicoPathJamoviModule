...
An `R6` class generator object for the `jjhistostatsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjhistostatsBase` -\> `jjhistostatsClass`

## Methods

### Public methods

- [`jjhistostatsClass$asSource()`](#method-jjhistostatsClass-asSource)

- [`jjhistostatsClass$clone()`](#method-jjhistostatsClass-clone)
...
- `jjhistostatsBase$initialize()`

------------------------------------------------------------------------

### `jjhistostatsClass$asSource()`
