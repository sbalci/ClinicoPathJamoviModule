...
`interruptedtimeseriesBase` -\> `interruptedtimeseriesClass`

## Methods

### Public methods

- [`interruptedtimeseriesClass$clone()`](#method-interruptedtimeseriesClass-clone)
...
- `interruptedtimeseriesBase$initialize()`

------------------------------------------------------------------------

### `interruptedtimeseriesClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    interruptedtimeseriesClass$clone(deep = FALSE)
