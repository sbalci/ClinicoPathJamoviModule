...
`fragilityindexBase` -\> `fragilityindexClass`

## Methods

### Public methods

- [`fragilityindexClass$clone()`](#method-fragilityindexClass-clone)
...
- `fragilityindexBase$initialize()`

------------------------------------------------------------------------

### `fragilityindexClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    fragilityindexClass$clone(deep = FALSE)
