...
An `R6` class generator object for the `jointmodelingClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jointmodelingBase` -\> `jointmodelingClass`

## Methods

### Public methods

- [`jointmodelingClass$clone()`](#method-jointmodelingClass-clone)
...
- `jointmodelingBase$initialize()`

------------------------------------------------------------------------

### `jointmodelingClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jointmodelingClass$clone(deep = FALSE)
