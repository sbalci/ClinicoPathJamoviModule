...
An `R6` class generator object for the `simonmakuchClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`simonmakuchBase` -\> `simonmakuchClass`

## Methods

### Public methods

- [`simonmakuchClass$clone()`](#method-simonmakuchClass-clone)
...
- `simonmakuchBase$initialize()`

------------------------------------------------------------------------

### `simonmakuchClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    simonmakuchClass$clone(deep = FALSE)
