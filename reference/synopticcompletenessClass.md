...
`synopticcompletenessBase` -\> `synopticcompletenessClass`

## Methods

### Public methods

- [`synopticcompletenessClass$clone()`](#method-synopticcompletenessClass-clone)
...
- `synopticcompletenessBase$initialize()`

------------------------------------------------------------------------

### `synopticcompletenessClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    synopticcompletenessClass$clone(deep = FALSE)
