...
An `R6` class generator object for the `clinicaldataintegrationClass`
...
`clinicaldataintegrationBase` -\> `clinicaldataintegrationClass`

## Methods

### Public methods

- [`clinicaldataintegrationClass$clone()`](#method-clinicaldataintegrationClass-clone)
...
- `clinicaldataintegrationBase$initialize()`

------------------------------------------------------------------------

### `clinicaldataintegrationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    clinicaldataintegrationClass$clone(deep = FALSE)
