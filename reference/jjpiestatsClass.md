...
An `R6` class generator object for the `jjpiestatsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjpiestatsBase` -\> `jjpiestatsClass`

## Methods

### Public methods

- [`jjpiestatsClass$asSource()`](#method-jjpiestatsClass-asSource)

- [`jjpiestatsClass$clone()`](#method-jjpiestatsClass-clone)
...
- `jjpiestatsBase$initialize()`

------------------------------------------------------------------------

### `jjpiestatsClass$asSource()`
