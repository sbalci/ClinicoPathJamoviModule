...
This function creates a "Table One" - a descriptive summary table
commonly used in clinicopathological research. It offers several output
styles using different packages (tableone, gtsummary, arsenal, and
janitor).

## Value

A formatted table according to the chosen style.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`tableoneBase` -\> `tableoneClass`

## Methods

### Public methods

- [`tableoneClass$asSource()`](#method-tableoneClass-asSource)

- [`tableoneClass$clone()`](#method-tableoneClass-clone)
...
- `tableoneBase$initialize()`

------------------------------------------------------------------------

### `tableoneClass$asSource()`
