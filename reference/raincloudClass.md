...
Raincloud plot using ggdist for comprehensive distribution analysis

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`raincloudBase` -\> `raincloudClass`

## Methods

### Public methods

- [`raincloudClass$asSource()`](#method-raincloudClass-asSource)

- [`raincloudClass$clone()`](#method-raincloudClass-clone)
...
- `raincloudBase$initialize()`

------------------------------------------------------------------------

### `raincloudClass$asSource()`
...
### `raincloudClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    raincloudClass$clone(deep = FALSE)
