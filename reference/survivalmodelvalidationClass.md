...
An `R6` class generator object for the `survivalmodelvalidationClass`
...
`survivalmodelvalidationBase` -\> `survivalmodelvalidationClass`

## Methods

### Public methods

- [`survivalmodelvalidationClass$clone()`](#method-survivalmodelvalidationClass-clone)
...
- `survivalmodelvalidationBase$initialize()`

------------------------------------------------------------------------

### `survivalmodelvalidationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    survivalmodelvalidationClass$clone(deep = FALSE)
