...
An `R6` class generator object for the `sequentialtestsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`sequentialtestsBase` -\> `sequentialtestsClass`

## Methods

### Public methods

- [`sequentialtestsClass$clone()`](#method-sequentialtestsClass-clone)
...
- `sequentialtestsBase$initialize()`

------------------------------------------------------------------------

### `sequentialtestsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    sequentialtestsClass$clone(deep = FALSE)
