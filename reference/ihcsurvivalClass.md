...
An `R6` class generator object for the `ihcsurvivalClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`ihcsurvivalBase` -\> `ihcsurvivalClass`

## Methods

### Public methods

- [`ihcsurvivalClass$clone()`](#method-ihcsurvivalClass-clone)
...
- `ihcsurvivalBase$initialize()`

------------------------------------------------------------------------

### `ihcsurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    ihcsurvivalClass$clone(deep = FALSE)
