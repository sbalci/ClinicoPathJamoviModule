...
An `R6` class generator object for the `pcaloadingheatmapClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`pcaloadingheatmapBase` -\> `pcaloadingheatmapClass`

## Methods

### Public methods

- [`pcaloadingheatmapClass$clone()`](#method-pcaloadingheatmapClass-clone)
...
- `pcaloadingheatmapBase$initialize()`

------------------------------------------------------------------------

### `pcaloadingheatmapClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pcaloadingheatmapClass$clone(deep = FALSE)
