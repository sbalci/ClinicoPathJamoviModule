...
An `R6` class generator object for the `jforestmodelClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jforestmodelBase` -\> `jforestmodelClass`

## Methods

### Public methods

- [`jforestmodelClass$clone()`](#method-jforestmodelClass-clone)
...
- `jforestmodelBase$initialize()`

------------------------------------------------------------------------

### `jforestmodelClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jforestmodelClass$clone(deep = FALSE)
