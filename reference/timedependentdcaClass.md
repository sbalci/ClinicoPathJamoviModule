...
`timedependentdcaBase` -\> `timedependentdcaClass`

## Methods

### Public methods

- [`timedependentdcaClass$clone()`](#method-timedependentdcaClass-clone)
...
- `timedependentdcaBase$initialize()`

------------------------------------------------------------------------

### `timedependentdcaClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    timedependentdcaClass$clone(deep = FALSE)
