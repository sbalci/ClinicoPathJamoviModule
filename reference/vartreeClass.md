...
An `R6` class generator object for the `vartreeClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`vartreeBase` -\> `vartreeClass`

## Methods

### Public methods

- [`vartreeClass$clone()`](#method-vartreeClass-clone)
