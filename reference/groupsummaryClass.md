...
An `R6` class generator object for the `groupsummaryClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`groupsummaryBase` -\> `groupsummaryClass`

## Methods

### Public methods

- [`groupsummaryClass$clone()`](#method-groupsummaryClass-clone)
...
- `groupsummaryBase$initialize()`

------------------------------------------------------------------------

### `groupsummaryClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    groupsummaryClass$clone(deep = FALSE)
