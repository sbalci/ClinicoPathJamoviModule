...
`treeadvancedBase` -\> `treeadvancedClass`

## Methods

### Public methods

- [`treeadvancedClass$clone()`](#method-treeadvancedClass-clone)
...
- `treeadvancedBase$initialize()`

------------------------------------------------------------------------

### `treeadvancedClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treeadvancedClass$clone(deep = FALSE)
