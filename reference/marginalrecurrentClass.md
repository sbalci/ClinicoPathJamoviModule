...
An `R6` class generator object for the `marginalrecurrentClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`marginalrecurrentBase` -\> `marginalrecurrentClass`

## Methods

### Public methods

- [`marginalrecurrentClass$clone()`](#method-marginalrecurrentClass-clone)
...
- `marginalrecurrentBase$initialize()`

------------------------------------------------------------------------

### `marginalrecurrentClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    marginalrecurrentClass$clone(deep = FALSE)
