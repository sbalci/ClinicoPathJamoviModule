...
An `R6` class generator object for the `mediansurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`mediansurvivalBase` -\> `mediansurvivalClass`

## Methods

### Public methods

- [`mediansurvivalClass$clone()`](#method-mediansurvivalClass-clone)
...
- `mediansurvivalBase$initialize()`

------------------------------------------------------------------------

### `mediansurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    mediansurvivalClass$clone(deep = FALSE)
