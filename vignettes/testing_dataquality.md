# Testing Checklist: Multi-Variable Visual Quality (`dataquality`)
...
Run the dedicated test suite for `dataquality`:

```r
testthat::test_file("tests/testthat/test-dataquality.R")
```
