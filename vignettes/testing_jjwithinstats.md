# Testing Checklist: Box-Violin Plots to Compare Within Groups (`jjwithinstats`)
...
Run the dedicated test suite for `jjwithinstats`:

```r
testthat::test_file("tests/testthat/test-jjwithinstats.R")
```
