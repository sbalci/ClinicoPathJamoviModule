# Testing Checklist: Combine Medical Decision Tests (`decisioncombine`)
...
Run the dedicated test suite for `decisioncombine`:

```r
testthat::test_file("tests/testthat/test-decisioncombine.R")
```
