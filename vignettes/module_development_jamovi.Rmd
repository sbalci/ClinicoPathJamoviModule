...
vignette: >
  %\VignetteIndexEntryModule Development for Jamovi
...
- Install jmvtools package with: `install.packages('jmvtools', repos=c('https://repo.jamovi.org', 'https://cran.r-project.org'))` 
