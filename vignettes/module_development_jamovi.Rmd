...
## Output variables in jamovi 1.6.16
                ...
                # all the cases i’ve illustrated so far are for when you know the number of columns you want to create in advance … none handle the situation where that number is determined by the analysis, at runtime, from the data. i’ll be adding that functionality shortly.
                # that’s most of it anyway. there’s still a few things we need to do, fixes, improvements. but we’ll add those in the next little while. let me know if you have any questions.
...
Use: **R 4.0.2**
https://cran.r-project.org/bin/macosx/R-4.0.2.pkg
...
```r
options(
repos = "https://cran.microsoft.com/snapshot/2020-08-24"
                )
```
...
<!-- Seol  2 hours ago -->
<!-- Oh yub, It works:+1: and I'm gonna add it to the "snowIRT" module later:grinning: Thanks again~~ -->




<!-- jonathon:whale2:  2 hours ago -->
<!-- :+1: -->
