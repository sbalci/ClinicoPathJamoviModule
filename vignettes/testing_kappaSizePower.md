# Testing Checklist: Power Approach for the Number of Subjects Required (`kappaSizePower`)
...
Run the dedicated test suite for `kappaSizePower`:

```r
testthat::test_file("tests/testthat/test-kappaSizePower.R")
```
