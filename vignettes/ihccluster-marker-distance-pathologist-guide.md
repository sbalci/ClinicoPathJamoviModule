...
- ✅ **Keep:** One marker from each group (e.g., TTF1 + p40)
- ❌ **Consider dropping:** Napsin A if TTF1 is positive (provides redundant info)
- 💰 **Cost savings:** Reduced antibody usage without losing diagnostic accuracy
