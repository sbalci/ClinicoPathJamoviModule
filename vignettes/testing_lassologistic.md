# Testing Checklist: LASSO Logistic Regression (`lassologistic`)
...
Run the dedicated test suite for `lassologistic`:

```r
testthat::test_file("tests/testthat/test-lassologistic.R")
```
