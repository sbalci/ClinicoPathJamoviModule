# Testing Checklist: Confidence Interval Approach for the Number of Subjects Required (`kappaSizeCI`)
...
Run the dedicated test suite for `kappaSizeCI`:

```r
testthat::test_file("tests/testthat/test-kappaSizeCI.R")
```
