# Testing Checklist: Chi-Square Post-Hoc Tests (`chisqposttest`)
...
Run the dedicated test suite for `chisqposttest`:

```r
testthat::test_file("tests/testthat/test-chisqposttest.R")
```
