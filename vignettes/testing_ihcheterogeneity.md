# Testing Checklist: IHC Heterogeneity Analysis (`ihcheterogeneity`)
...
Run the dedicated test suite for `ihcheterogeneity`:

```r
testthat::test_file("tests/testthat/test-ihcheterogeneity.R")
```
