# Testing Checklist: Decision Curve Analysis (`decisioncurve`)
...
Run the dedicated test suite for `decisioncurve`:

```r
testthat::test_file("tests/testthat/test-decisioncurve.R")
```
