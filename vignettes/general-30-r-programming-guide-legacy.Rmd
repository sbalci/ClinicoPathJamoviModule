...
output: 
  rmarkdown::html_vignette:
    ...
    fig_height: 6
vignette: >
  %\VignetteIndexEntry{R Programming Guide for jjstatsplot}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(comment = "#>", collapse = TRUE, eval = TRUE, fig.width = 7, fig.height = 5)
```
...
# pie_result$plot
str(pie_result)
# Try alternative plot access if needed
```
...
# then use standard ggplot2 syntax for modifications
```
