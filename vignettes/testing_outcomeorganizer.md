# Testing Checklist: Outcome Organizer for Survival Analysis (`outcomeorganizer`)
...
Run the dedicated test suite for `outcomeorganizer`:

```r
testthat::test_file("tests/testthat/test-outcomeorganizer.R")
```
