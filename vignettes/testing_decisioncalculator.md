# Testing Checklist: Medical Decision Calculator (`decisioncalculator`)
...
Run the dedicated test suite for `decisioncalculator`:

```r
testthat::test_file("tests/testthat/test-decisioncalculator.R")
```
