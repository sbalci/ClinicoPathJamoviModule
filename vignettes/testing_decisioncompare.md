# Testing Checklist: Compare Medical Decision Tests (`decisioncompare`)
...
Run the dedicated test suite for `decisioncompare`:

```r
testthat::test_file("tests/testthat/test-decisioncompare.R")
```
