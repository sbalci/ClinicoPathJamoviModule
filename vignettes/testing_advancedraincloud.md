# Testing Checklist: Advanced Raincloud Plot (`advancedraincloud`)
...
Run the dedicated test suite for `advancedraincloud`:

```r
testthat::test_file("tests/testthat/test-advancedraincloud.R")
```
