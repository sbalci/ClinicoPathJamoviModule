# Testing Checklist: Dot Chart (Summary vs Reference Value) (`jjdotchart`)
...
Run the dedicated test suite for `jjdotchart`:

```r
testthat::test_file("tests/testthat/test-jjdotchart.R")
```
