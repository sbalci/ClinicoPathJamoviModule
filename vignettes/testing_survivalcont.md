# Testing Checklist: Survival Analysis for Continuous Variable (`survivalcont`)
...
Run the dedicated test suite for `survivalcont`:

```r
testthat::test_file("tests/testthat/test-survivalcont.R")
```
