# Testing Checklist: Outlier Detection (`outlierdetection`)
...
Run the dedicated test suite for `outlierdetection`:

```r
testthat::test_file("tests/testthat/test-outlierdetection.R")
```
