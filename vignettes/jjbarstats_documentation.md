# Bar Charts - Feature Mapping Specification

## Feature-to-Code Mapping

- **Analysis Function**: `jjbarstats`
- **Module**: `JJStatsPlot`
...
| `digitsperc` | UI Control `digitsperc` | `self$options$digitsperc` | Output item / Table |
...
| `addGGPubrBalloon` | UI Control `addGGPubrBalloon` | `self$options$addGGPubrBalloon` | Output item / Table |
| `ggpubrBalloonPalette` | UI Control `ggpubrBalloonPalette` | `self$options$ggpubrBalloonPalette` | Output item / Table |

## Verification Checklist

- [x] All options defined in `.a.yaml` have matching UI bindings in `.u.yaml`.
- [x] Backend `R/jjbarstats.b.R` references all declared options safely.
