# Testing Checklist: Multivariable Survival Analysis (`multisurvival`)
...
Run the dedicated test suite for `multisurvival`:

```r
testthat::test_file("tests/testthat/test-multisurvival.R")
```
