# Testing Checklist: Comprehensive Time Interval Calculator (`timeinterval`)
...
Run the dedicated test suite for `timeinterval`:

```r
testthat::test_file("tests/testthat/test-timeinterval.R")
```
