# Testing Checklist: Advanced ROC Analysis (`psychopdaROC`)
...
Run the dedicated test suite for `psychopdaROC`:

```r
testthat::test_file("tests/testthat/test-psychopdaROC.R")
```
