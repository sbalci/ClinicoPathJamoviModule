# Testing Checklist: Analysis Without Gold Standard (`nogoldstandard`)
...
Run the dedicated test suite for `nogoldstandard`:

```r
testthat::test_file("tests/testthat/test-nogoldstandard.R")
```
