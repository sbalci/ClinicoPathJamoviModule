...
The `showSummary = TRUE` option produces a natural-language results paragraph
suitable for copying into manuscripts or reports.
...
Different seeds may produce different variable selections, especially when
predictors have similar importance. For publications, always report the seed used.
