# Testing Checklist: Horizontal Box-Violin Comparison (`jjdotplotstats`)
...
Run the dedicated test suite for `jjdotplotstats`:

```r
testthat::test_file("tests/testthat/test-jjdotplotstats.R")
```
