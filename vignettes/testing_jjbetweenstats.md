# Testing Checklist: Box-Violin Plots to Compare Between Groups (`jjbetweenstats`)
...
Run the dedicated test suite for `jjbetweenstats`:

```r
testthat::test_file("tests/testthat/test-jjbetweenstats.R")
```
