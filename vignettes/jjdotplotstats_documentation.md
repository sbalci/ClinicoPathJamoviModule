# Horizontal Box-Violin Comparison - Feature Mapping Specification

## Feature-to-Code Mapping

- **Analysis Function**: `jjdotplotstats`
- **Module**: `JJStatsPlotT`
...
| `testvalueline` | UI Control `testvalueline` | `self$options$testvalueline` | Output item / Table |
| `centralityparameter` | UI Control `centralityparameter` | `self$options$centralityparameter` | Output item / Table |
| `centralityk` | UI Control `centralityk` | `self$options$centralityk` | Output item / Table |
...
- [x] Backend `R/jjdotplotstats.b.R` references all declared options safely.
