# Testing Checklist: Summary of Categorical Variables (`reportcat`)
...
Run the dedicated test suite for `reportcat`:

```r
testthat::test_file("tests/testthat/test-reportcat.R")
```
