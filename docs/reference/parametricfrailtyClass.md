...
An `R6` class generator object for the `parametricfrailtyClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`parametricfrailtyBase` -\> `parametricfrailtyClass`

## Methods

### Public methods

- [`parametricfrailtyClass$clone()`](#method-parametricfrailtyClass-clone)
...
- `parametricfrailtyBase$initialize()`

------------------------------------------------------------------------

### `parametricfrailtyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    parametricfrailtyClass$clone(deep = FALSE)
