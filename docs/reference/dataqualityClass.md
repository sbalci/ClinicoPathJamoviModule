...
HTML summary of data quality issues including duplicates and missing
values

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`dataqualityBase` -\> `dataqualityClass`

## Methods

### Public methods

- [`dataqualityClass$clone()`](#method-dataqualityClass-clone)
...
- `dataqualityBase$initialize()`

------------------------------------------------------------------------

### `dataqualityClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    dataqualityClass$clone(deep = FALSE)
