...
Advanced raincloud plots using ggrain package

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`advancedraincloudBase` -\> `advancedraincloudClass`

## Methods

### Public methods

- [`advancedraincloudClass$clone()`](#method-advancedraincloudClass-clone)
...
- `advancedraincloudBase$initialize()`

------------------------------------------------------------------------

### `advancedraincloudClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    advancedraincloudClass$clone(deep = FALSE)
