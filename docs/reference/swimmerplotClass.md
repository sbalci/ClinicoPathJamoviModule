...
`swimmerplotBase` -\> `swimmerplotClass`

## Methods

### Public methods

- [`swimmerplotClass$asSource()`](#method-swimmerplotClass-asSource)

- [`swimmerplotClass$clone()`](#method-swimmerplotClass-clone)
...
- `swimmerplotBase$initialize()`

------------------------------------------------------------------------

### `swimmerplotClass$asSource()`
...
### `swimmerplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    swimmerplotClass$clone(deep = FALSE)
