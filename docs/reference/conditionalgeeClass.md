...
`conditionalgeeBase` -\> `conditionalgeeClass`

## Methods

### Public methods

- [`conditionalgeeClass$clone()`](#method-conditionalgeeClass-clone)
...
- `conditionalgeeBase$initialize()`

------------------------------------------------------------------------

### `conditionalgeeClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    conditionalgeeClass$clone(deep = FALSE)
