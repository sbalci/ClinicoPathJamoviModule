...
An `R6` class generator object for the `pcacoxClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`pcacoxBase` -\> `pcacoxClass`

## Methods

### Public methods

- [`pcacoxClass$clone()`](#method-pcacoxClass-clone)
