...
An `R6` class generator object for the `biomarkerdiscoveryClass`
...
`biomarkerdiscoveryBase` -\> `biomarkerdiscoveryClass`

## Methods

### Public methods

- [`biomarkerdiscoveryClass$clone()`](#method-biomarkerdiscoveryClass-clone)
...
- `biomarkerdiscoveryBase$initialize()`

------------------------------------------------------------------------

### `biomarkerdiscoveryClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    biomarkerdiscoveryClass$clone(deep = FALSE)
