...
An `R6` class generator object for the `outbreakanalysisClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`outbreakanalysisBase` -\> `outbreakanalysisClass`

## Methods

### Public methods

- [`outbreakanalysisClass$clone()`](#method-outbreakanalysisClass-clone)
...
- `outbreakanalysisBase$initialize()`

------------------------------------------------------------------------

### `outbreakanalysisClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    outbreakanalysisClass$clone(deep = FALSE)
