...
An `R6` class generator object for the `conditionalinferenceClass`
...
`conditionalinferenceBase` -\> `conditionalinferenceClass`

## Methods

### Public methods

- [`conditionalinferenceClass$clone()`](#method-conditionalinferenceClass-clone)
...
- `conditionalinferenceBase$initialize()`

------------------------------------------------------------------------

### `conditionalinferenceClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    conditionalinferenceClass$clone(deep = FALSE)
