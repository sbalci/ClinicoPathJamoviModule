...
This function calculates interrater reliability for ordinal or
categorical data.
...
The function calculates Cohen's kappa for two raters and Fleiss' kappa
...
- [`agreementClass$clone()`](#method-agreementClass-clone)
...
- `agreementBase$initialize()`

------------------------------------------------------------------------

### `agreementClass$clone()`
