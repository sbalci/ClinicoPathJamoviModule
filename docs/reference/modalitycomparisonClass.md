...
An `R6` class generator object for the `modalitycomparisonClass`
...
`modalitycomparisonBase` -\> `modalitycomparisonClass`

## Methods

### Public methods

- [`modalitycomparisonClass$clone()`](#method-modalitycomparisonClass-clone)
...
- `modalitycomparisonBase$initialize()`

------------------------------------------------------------------------

### `modalitycomparisonClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    modalitycomparisonClass$clone(deep = FALSE)
