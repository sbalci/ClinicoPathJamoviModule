...
Generates an age pyramid plot from the provided data. The function
allows customization of bin width (age group granularity) and plot
...
`agepyramidBase` -\> `agepyramidClass`

## Methods

### Public methods

- [`agepyramidClass$clone()`](#method-agepyramidClass-clone)
...
- `agepyramidBase$initialize()`

------------------------------------------------------------------------

### `agepyramidClass$clone()`
