...
`deeplearningpredictionBase` -\> `deeplearningpredictionClass`

## Methods

### Public methods

- [`deeplearningpredictionClass$clone()`](#method-deeplearningpredictionClass-clone)
...
- `deeplearningpredictionBase$initialize()`

------------------------------------------------------------------------

### `deeplearningpredictionClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    deeplearningpredictionClass$clone(deep = FALSE)
