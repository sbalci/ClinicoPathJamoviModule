...
An `R6` class generator object for the `mlpathologyClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`mlpathologyBase` -\> `mlpathologyClass`

## Methods

### Public methods

- [`mlpathologyClass$clone()`](#method-mlpathologyClass-clone)
...
- `mlpathologyBase$initialize()`

------------------------------------------------------------------------

### `mlpathologyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    mlpathologyClass$clone(deep = FALSE)
