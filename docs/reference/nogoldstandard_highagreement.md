...
- Test2:
  ...
  Factor: Second test ("Negative", "Positive"), Sens=0.88, Spec=0.88,
  95% agreement
...
Simulated with 35% prevalence. High correlation between tests (95%
conditional agreement) tests latent class model assumptions about
