...
An `R6` class generator object for the `jcomplexupsetClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jcomplexupsetBase` -\> `jcomplexupsetClass`

## Methods

### Public methods

- [`jcomplexupsetClass$asSource()`](#method-jcomplexupsetClass-asSource)

- [`jcomplexupsetClass$clone()`](#method-jcomplexupsetClass-clone)
...
- `jcomplexupsetBase$initialize()`

------------------------------------------------------------------------

### `jcomplexupsetClass$asSource()`
...
### `jcomplexupsetClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jcomplexupsetClass$clone(deep = FALSE)
