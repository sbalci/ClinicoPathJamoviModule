...
An `R6` class generator object for the `desctoolsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`desctoolsBase` -\> `desctoolsClass`

## Methods

### Public methods

- [`desctoolsClass$clone()`](#method-desctoolsClass-clone)
...
- `desctoolsBase$initialize()`

------------------------------------------------------------------------

### `desctoolsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    desctoolsClass$clone(deep = FALSE)
