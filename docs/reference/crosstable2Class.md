...
In addition to visualizing associations, this function now optionally
provides an exportable CSV version of the cross table.

## Value

The function produces an HTML table output, and if requested, an
additional downloadable CSV export.
...
guidance is provided via HTML to-do messages.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`crosstable2Base` -\> `crosstable2Class`

## Methods

### Public methods

- [`crosstable2Class$asSource()`](#method-crosstable2Class-asSource)

- [`crosstable2Class$clone()`](#method-crosstable2Class-clone)
...
- `crosstable2Base$initialize()`

------------------------------------------------------------------------

### `crosstable2Class$asSource()`
...
### `crosstable2Class$clone()`

The objects of this class are cloneable with this method.

#### Usage

    crosstable2Class$clone(deep = FALSE)
