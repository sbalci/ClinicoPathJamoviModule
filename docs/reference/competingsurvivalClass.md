...
An `R6` class generator object for the `competingsurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`competingsurvivalBase` -\> `competingsurvivalClass`

## Methods

### Public methods

- [`competingsurvivalClass$clone()`](#method-competingsurvivalClass-clone)
...
- `competingsurvivalBase$initialize()`

------------------------------------------------------------------------

### `competingsurvivalClass$clone()`
