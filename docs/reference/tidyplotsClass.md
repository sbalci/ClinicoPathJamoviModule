...
`tidyplotsBase` -\> `tidyplotsClass`

## Methods

### Public methods

- [`tidyplotsClass$clone()`](#method-tidyplotsClass-clone)
...
- `tidyplotsBase$initialize()`

------------------------------------------------------------------------

### `tidyplotsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    tidyplotsClass$clone(deep = FALSE)
