...
An `R6` class generator object for the `jjsyndromicplotClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjsyndromicplotBase` -\> `jjsyndromicplotClass`

## Methods

### Public methods

- [`jjsyndromicplotClass$clone()`](#method-jjsyndromicplotClass-clone)
...
- `jjsyndromicplotBase$initialize()`

------------------------------------------------------------------------

### `jjsyndromicplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjsyndromicplotClass$clone(deep = FALSE)
