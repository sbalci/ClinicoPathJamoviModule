...
`entropyanalysisBase` -\> `entropyanalysisClass`

## Methods

### Public methods

- [`entropyanalysisClass$clone()`](#method-entropyanalysisClass-clone)
...
- `entropyanalysisBase$initialize()`

------------------------------------------------------------------------

### `entropyanalysisClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    entropyanalysisClass$clone(deep = FALSE)
