...
An `R6` class generator object for the `jjcoefstatsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjcoefstatsBase` -\> `jjcoefstatsClass`

## Methods

### Public methods

- [`jjcoefstatsClass$asSource()`](#method-jjcoefstatsClass-asSource)

- [`jjcoefstatsClass$clone()`](#method-jjcoefstatsClass-clone)
...
- `jjcoefstatsBase$initialize()`

------------------------------------------------------------------------

### `jjcoefstatsClass$asSource()`
...
### `jjcoefstatsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjcoefstatsClass$clone(deep = FALSE)
