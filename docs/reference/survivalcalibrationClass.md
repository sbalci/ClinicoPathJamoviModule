...
An `R6` class generator object for the `survivalcalibrationClass`
...
`survivalcalibrationBase` -\> `survivalcalibrationClass`

## Methods

### Public methods

- [`survivalcalibrationClass$clone()`](#method-survivalcalibrationClass-clone)
...
- `survivalcalibrationBase$initialize()`

------------------------------------------------------------------------

### `survivalcalibrationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    survivalcalibrationClass$clone(deep = FALSE)
