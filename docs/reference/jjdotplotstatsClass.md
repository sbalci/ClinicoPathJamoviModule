...
`jjdotplotstatsBase` -\> `jjdotplotstatsClass`

## Methods

### Public methods

- [`jjdotplotstatsClass$asSource()`](#method-jjdotplotstatsClass-asSource)

- [`jjdotplotstatsClass$clone()`](#method-jjdotplotstatsClass-clone)
...
- `jjdotplotstatsBase$initialize()`

------------------------------------------------------------------------

### `jjdotplotstatsClass$asSource()`
