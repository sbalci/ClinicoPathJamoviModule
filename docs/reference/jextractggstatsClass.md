...
An `R6` class generator object for the `jextractggstatsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jextractggstatsBase` -\> `jextractggstatsClass`

## Methods

### Public methods

- [`jextractggstatsClass$clone()`](#method-jextractggstatsClass-clone)
...
- `jextractggstatsBase$initialize()`

------------------------------------------------------------------------

### `jextractggstatsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jextractggstatsClass$clone(deep = FALSE)
