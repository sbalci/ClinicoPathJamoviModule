...
R6 class for performing conditional survival analysis.

## Value

An `R6` class generator object for the `condsurvivalClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`condsurvivalBase` -\> `condsurvivalClass`

## Methods

### Public methods

- [`condsurvivalClass$asSource()`](#method-condsurvivalClass-asSource)

- [`condsurvivalClass$clone()`](#method-condsurvivalClass-clone)
...
- `condsurvivalBase$initialize()`

------------------------------------------------------------------------

### `condsurvivalClass$asSource()`
...
### `condsurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    condsurvivalClass$clone(deep = FALSE)
