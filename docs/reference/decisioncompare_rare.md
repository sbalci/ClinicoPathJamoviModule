...
#>  performance, with 86.4% sensitivity (95% CI: 65.1-97.1%), 92.4%
#>  specificity (95% CI: 88.7-95.3%), 37.6% positive predictive value,
#>  99.2% negative predictive value, and 92% overall accuracy. The
#>  likelihood ratio for positive results was 11.43 and for negative
#>  results was 0.15.<h3 style="color: #27ae60; margin-top: 30px;"> Report
#>  Sentences
#> 
...
#>  86.4% sensitivity (95% CI: 65.1-97.1%), 92.4% specificity (95% CI:
#>  88.7-95.3%), 37.6% positive predictive value, 99.2% negative
#>  predictive value, and 92% overall accuracy. The likelihood ratio for
#>  positive results was 11.43 and for negative results was 0.15.
#> 
