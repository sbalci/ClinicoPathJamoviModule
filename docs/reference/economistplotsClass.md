...
jamovi, providing access to The Economist's signature distribution
visualization style. Features include:
...
`economistplotsBase` -\> `economistplotsClass`

## Methods

### Public methods

- [`economistplotsClass$clone()`](#method-economistplotsClass-clone)
...
- `economistplotsBase$initialize()`

------------------------------------------------------------------------

### `economistplotsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    economistplotsClass$clone(deep = FALSE)
