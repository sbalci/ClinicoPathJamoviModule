...
An `R6` class generator object for the `icccoeffClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`icccoeffBase` -\> `icccoeffClass`

## Methods

### Public methods

- [`icccoeffClass$clone()`](#method-icccoeffClass-clone)
