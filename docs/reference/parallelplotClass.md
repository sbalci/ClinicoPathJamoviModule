...
`parallelplotBase` -\> `parallelplotClass`

## Methods

### Public methods

- [`parallelplotClass$clone()`](#method-parallelplotClass-clone)
...
- `parallelplotBase$initialize()`

------------------------------------------------------------------------

### `parallelplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    parallelplotClass$clone(deep = FALSE)
