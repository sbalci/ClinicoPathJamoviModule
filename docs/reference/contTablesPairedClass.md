...
R6 class for performing paired contingency table analysis (McNemar
test).

## Value

An `R6` class generator object for the `contTablesPairedClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`contTablesPairedBase` -\> `contTablesPairedClass`

## Methods

### Public methods

- [`contTablesPairedClass$asSource()`](#method-contTablesPairedClass-asSource)

- [`contTablesPairedClass$clone()`](#method-contTablesPairedClass-clone)
...
- `contTablesPairedBase$initialize()`

------------------------------------------------------------------------

### `contTablesPairedClass$asSource()`
...
### `contTablesPairedClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    contTablesPairedClass$clone(deep = FALSE)
