...
`standardizedratioBase` -\> `standardizedratioClass`

## Methods

### Public methods

- [`standardizedratioClass$clone()`](#method-standardizedratioClass-clone)
...
- `standardizedratioBase$initialize()`

------------------------------------------------------------------------

### `standardizedratioClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    standardizedratioClass$clone(deep = FALSE)
