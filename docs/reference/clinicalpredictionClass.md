...
An `R6` class generator object for the `clinicalpredictionClass`
...
`clinicalpredictionBase` -\> `clinicalpredictionClass`

## Methods

### Public methods

- [`clinicalpredictionClass$clone()`](#method-clinicalpredictionClass-clone)
...
- `clinicalpredictionBase$initialize()`

------------------------------------------------------------------------

### `clinicalpredictionClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    clinicalpredictionClass$clone(deep = FALSE)
