...
An `R6` class generator object for the `partialcorrelationClass`
...
`partialcorrelationBase` -\> `partialcorrelationClass`

## Methods

### Public methods

- [`partialcorrelationClass$clone()`](#method-partialcorrelationClass-clone)
...
- `partialcorrelationBase$initialize()`

------------------------------------------------------------------------

### `partialcorrelationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    partialcorrelationClass$clone(deep = FALSE)
