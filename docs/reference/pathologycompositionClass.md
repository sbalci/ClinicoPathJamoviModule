...
An `R6` class generator object for the `pathologycompositionClass`
...
`pathologycompositionBase` -\> `pathologycompositionClass`

## Methods

### Public methods

- [`pathologycompositionClass$clone()`](#method-pathologycompositionClass-clone)
...
- `pathologycompositionBase$initialize()`

------------------------------------------------------------------------

### `pathologycompositionClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pathologycompositionClass$clone(deep = FALSE)
