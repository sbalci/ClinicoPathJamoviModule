...
An `R6` class generator object for the `pagetrendtestClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`pagetrendtestBase` -\> `pagetrendtestClass`

## Methods

### Public methods

- [`pagetrendtestClass$clone()`](#method-pagetrendtestClass-clone)
...
- `pagetrendtestBase$initialize()`

------------------------------------------------------------------------

### `pagetrendtestClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pagetrendtestClass$clone(deep = FALSE)
