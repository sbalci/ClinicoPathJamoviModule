...
An `R6` class generator object for the `landmarkanalysisClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`landmarkanalysisBase` -\> `landmarkanalysisClass`

## Methods

### Public methods

- [`landmarkanalysisClass$clone()`](#method-landmarkanalysisClass-clone)
...
- `landmarkanalysisBase$initialize()`

------------------------------------------------------------------------

### `landmarkanalysisClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    landmarkanalysisClass$clone(deep = FALSE)
