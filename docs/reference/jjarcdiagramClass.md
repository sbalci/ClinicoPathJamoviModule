...
An `R6` class generator object for the `jjarcdiagramClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjarcdiagramBase` -\> `jjarcdiagramClass`

## Methods

### Public methods

- [`jjarcdiagramClass$clone()`](#method-jjarcdiagramClass-clone)
...
- `jjarcdiagramBase$initialize()`

------------------------------------------------------------------------

### `jjarcdiagramClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jjarcdiagramClass$clone(deep = FALSE)
