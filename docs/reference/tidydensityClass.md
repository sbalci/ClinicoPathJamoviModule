...
Interactive distribution analysis using TidyDensity package

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`tidydensityBase` -\> `tidydensityClass`

## Methods

### Public methods

- [`tidydensityClass$clone()`](#method-tidydensityClass-clone)
...
- `tidydensityBase$initialize()`

------------------------------------------------------------------------

### `tidydensityClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    tidydensityClass$clone(deep = FALSE)
