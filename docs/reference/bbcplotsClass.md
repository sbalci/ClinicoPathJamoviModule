...
An `R6` class generator object for the `bbcplotsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`bbcplotsBase` -\> `bbcplotsClass`

## Methods

### Public methods

- [`bbcplotsClass$clone()`](#method-bbcplotsClass-clone)
...
#### Usage
    ...
    bbcplotsClass$clone(deep = FALSE)
