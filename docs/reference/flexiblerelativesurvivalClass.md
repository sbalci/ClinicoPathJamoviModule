...
An `R6` class generator object for the `flexiblerelativesurvivalClass`
...
`flexiblerelativesurvivalBase` -\> `flexiblerelativesurvivalClass`

## Methods

### Public methods

- [`flexiblerelativesurvivalClass$clone()`](#method-flexiblerelativesurvivalClass-clone)
...
- `flexiblerelativesurvivalBase$initialize()`

------------------------------------------------------------------------

### `flexiblerelativesurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    flexiblerelativesurvivalClass$clone(deep = FALSE)
