...
`crosstableBase` -\> `crosstableClass`

## Methods

### Public methods

- [`crosstableClass$asSource()`](#method-crosstableClass-asSource)

- [`crosstableClass$clone()`](#method-crosstableClass-clone)
...
- `crosstableBase$initialize()`

------------------------------------------------------------------------

### `crosstableClass$asSource()`
