...
An `R6` class generator object for the `clinicaldashboardClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`clinicaldashboardBase` -\> `clinicaldashboardClass`

## Methods

### Public methods

- [`clinicaldashboardClass$clone()`](#method-clinicaldashboardClass-clone)
...
- `clinicaldashboardBase$initialize()`

------------------------------------------------------------------------

### `clinicaldashboardClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    clinicaldashboardClass$clone(deep = FALSE)
