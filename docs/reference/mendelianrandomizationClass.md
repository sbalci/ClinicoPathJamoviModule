...
An `R6` class generator object for the `mendelianrandomizationClass`
...
`mendelianrandomizationBase` -\> `mendelianrandomizationClass`

## Methods

### Public methods

- [`mendelianrandomizationClass$clone()`](#method-mendelianrandomizationClass-clone)
...
- `mendelianrandomizationBase$initialize()`

------------------------------------------------------------------------

### `mendelianrandomizationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    mendelianrandomizationClass$clone(deep = FALSE)
