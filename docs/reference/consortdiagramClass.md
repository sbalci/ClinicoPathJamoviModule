...
An `R6` class generator object for the `consortdiagramClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`consortdiagramBase` -\> `consortdiagramClass`

## Methods

### Public methods

- [`consortdiagramClass$clone()`](#method-consortdiagramClass-clone)
...
- `consortdiagramBase$initialize()`

------------------------------------------------------------------------

### `consortdiagramClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    consortdiagramClass$clone(deep = FALSE)
