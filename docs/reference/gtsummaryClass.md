...
An `R6` class generator object for the `gtsummaryClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`gtsummaryBase` -\> `gtsummaryClass`

## Methods

### Public methods

- [`gtsummaryClass$clone()`](#method-gtsummaryClass-clone)
...
- `gtsummaryBase$initialize()`

------------------------------------------------------------------------

### `gtsummaryClass$clone()`
