...
An `R6` class generator object for the `decisioncalculatorClass`
...
`decisioncalculatorBase` -\> `decisioncalculatorClass`

## Methods

### Public methods

- [`decisioncalculatorClass$clone()`](#method-decisioncalculatorClass-clone)
...
- `decisioncalculatorBase$initialize()`

------------------------------------------------------------------------

### `decisioncalculatorClass$clone()`
