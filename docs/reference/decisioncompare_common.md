...
#>  performance with 79.8% sensitivity (95% CI: [see confidence interval
#>  table]), 83.9% specificity (95% CI: [see confidence interval table]),
#>  90.2% positive predictive value, 69.1% negative predictive value, and
#>  81.2% overall accuracy. The likelihood ratio for positive results was
#>  4.97 and for negative results was 0.24.<h3 style="color: #27ae60;
...
#>  79.8% sensitivity (95% CI: [see confidence interval table]), 83.9%
#>  specificity (95% CI: [see confidence interval table]), 90.2% positive
#>  predictive value, 69.1% negative predictive value, and 81.2% overall
#>  accuracy. The likelihood ratio for positive results was 4.97 and for
#>  negative results was 0.24.
#> 
