...
`leaveonecenteroutBase` -\> `leaveonecenteroutClass`

## Methods

### Public methods

- [`leaveonecenteroutClass$clone()`](#method-leaveonecenteroutClass-clone)
...
- `leaveonecenteroutBase$initialize()`

------------------------------------------------------------------------

### `leaveonecenteroutClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    leaveonecenteroutClass$clone(deep = FALSE)
