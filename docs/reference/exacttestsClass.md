...
An `R6` class generator object for the `exacttestsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`exacttestsBase` -\> `exacttestsClass`

## Methods

### Public methods

- [`exacttestsClass$clone()`](#method-exacttestsClass-clone)
...
- `exacttestsBase$initialize()`

------------------------------------------------------------------------

### `exacttestsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    exacttestsClass$clone(deep = FALSE)
