...
An `R6` class generator object for the `coefplotClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`coefplotBase` -\> `coefplotClass`

## Methods

### Public methods

- [`coefplotClass$clone()`](#method-coefplotClass-clone)
...
#### Usage
    ...
    coefplotClass$clone(deep = FALSE)
