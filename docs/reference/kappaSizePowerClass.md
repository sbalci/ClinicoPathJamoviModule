...
`kappaSizePowerBase` -\> `kappaSizePowerClass`

## Methods

### Public methods

- [`kappaSizePowerClass$clone()`](#method-kappaSizePowerClass-clone)
...
- `kappaSizePowerBase$initialize()`

------------------------------------------------------------------------

### `kappaSizePowerClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    kappaSizePowerClass$clone(deep = FALSE)
