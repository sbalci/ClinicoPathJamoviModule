...
`latentbiomarkerBase` -\> `latentbiomarkerClass`

## Methods

### Public methods

- [`latentbiomarkerClass$clone()`](#method-latentbiomarkerClass-clone)
...
- `latentbiomarkerBase$initialize()`

------------------------------------------------------------------------

### `latentbiomarkerClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    latentbiomarkerClass$clone(deep = FALSE)
