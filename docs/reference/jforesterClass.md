...
An `R6` class generator object for the `jforesterClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jforesterBase` -\> `jforesterClass`

## Methods

### Public methods

- [`jforesterClass$clone()`](#method-jforesterClass-clone)
...
- `jforesterBase$initialize()`

------------------------------------------------------------------------

### `jforesterClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jforesterClass$clone(deep = FALSE)
