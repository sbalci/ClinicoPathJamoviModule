...
binary classification problems. Supports LASSO, Ridge, and Elastic Net
...
`lassologisticBase` -\> `lassologisticClass`

## Methods

### Public methods

- [`lassologisticClass$clone()`](#method-lassologisticClass-clone)
...
- `lassologisticBase$initialize()`

------------------------------------------------------------------------

### `lassologisticClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    lassologisticClass$clone(deep = FALSE)
