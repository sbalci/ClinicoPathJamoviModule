...
An `R6` class generator object for the `enhancedcorrelationClass`
...
`enhancedcorrelationBase` -\> `enhancedcorrelationClass`

## Methods

### Public methods

- [`enhancedcorrelationClass$clone()`](#method-enhancedcorrelationClass-clone)
...
- `enhancedcorrelationBase$initialize()`

------------------------------------------------------------------------

### `enhancedcorrelationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    enhancedcorrelationClass$clone(deep = FALSE)
