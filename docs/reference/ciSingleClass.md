...
An `R6` class generator object for the `ciSingleClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`ciSingleBase` -\> `ciSingleClass`

## Methods

### Public methods

- [`ciSingleClass$clone()`](#method-ciSingleClass-clone)
...
#### Usage
    ...
    ciSingleClass$clone(deep = FALSE)
