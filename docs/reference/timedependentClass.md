...
An `R6` class generator object for the `timedependentClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`timedependentBase` -\> `timedependentClass`

## Methods

### Public methods

- [`timedependentClass$clone()`](#method-timedependentClass-clone)
...
- `timedependentBase$initialize()`

------------------------------------------------------------------------

### `timedependentClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    timedependentClass$clone(deep = FALSE)
