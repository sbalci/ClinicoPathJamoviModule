...
An `R6` class generator object for the `grafifyClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`grafifyBase` -\> `grafifyClass`

## Methods

### Public methods

- [`grafifyClass$clone()`](#method-grafifyClass-clone)
