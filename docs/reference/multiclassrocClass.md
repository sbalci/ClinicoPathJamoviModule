...
An `R6` class generator object for the `multiclassrocClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`multiclassrocBase` -\> `multiclassrocClass`

## Methods

### Public methods

- [`multiclassrocClass$clone()`](#method-multiclassrocClass-clone)
...
- `multiclassrocBase$initialize()`

------------------------------------------------------------------------

### `multiclassrocClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    multiclassrocClass$clone(deep = FALSE)
