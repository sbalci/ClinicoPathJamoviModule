...
Comprehensive river plot, alluvial diagram, and stream chart
visualization for categorical flow analysis. Combines functionality for
temporal flows, individual entity tracking, aggregate trends, and
...
`riverplotBase` -\> `riverplotClass`

## Methods

### Public methods

- [`riverplotClass$clone()`](#method-riverplotClass-clone)
...
- `riverplotBase$initialize()`

------------------------------------------------------------------------

### `riverplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    riverplotClass$clone(deep = FALSE)
