...
approaches for creating professional bar charts. Inspired by "A Bar
...
3.  Statistical Annotations: Integrated statistical tests and
    annotations
...
`advancedbarplotBase` -\> `advancedbarplotClass`

## Methods

### Public methods

- [`advancedbarplotClass$clone()`](#method-advancedbarplotClass-clone)
...
- `advancedbarplotBase$initialize()`

------------------------------------------------------------------------

### `advancedbarplotClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    advancedbarplotClass$clone(deep = FALSE)
