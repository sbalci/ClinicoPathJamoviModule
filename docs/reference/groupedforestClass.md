...
Grouped forest plot showing treatment effects across subgroups

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`groupedforestBase` -\> `groupedforestClass`

## Methods

### Public methods

- [`groupedforestClass$clone()`](#method-groupedforestClass-clone)
...
- `groupedforestBase$initialize()`

------------------------------------------------------------------------

### `groupedforestClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    groupedforestClass$clone(deep = FALSE)
