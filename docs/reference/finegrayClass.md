...
`finegrayBase` -\> `finegrayClass`

## Methods

### Public methods

- [`finegrayClass$asSource()`](#method-finegrayClass-asSource)

- [`finegrayClass$clone()`](#method-finegrayClass-clone)
...
- `finegrayBase$initialize()`

------------------------------------------------------------------------

### `finegrayClass$asSource()`
...
#### Usage
    ...
    finegrayClass$clone(deep = FALSE)
