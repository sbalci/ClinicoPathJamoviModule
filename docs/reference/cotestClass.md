...
An `R6` class generator object for the `cotestClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`cotestBase` -\> `cotestClass`

## Methods

### Public methods

- [`cotestClass$clone()`](#method-cotestClass-clone)
