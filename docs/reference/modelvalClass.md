...
An `R6` class generator object for the `modelvalClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`modelvalBase` -\> `modelvalClass`

## Methods

### Public methods

- [`modelvalClass$clone()`](#method-modelvalClass-clone)
...
#### Usage
    ...
    modelvalClass$clone(deep = FALSE)
