...
Comprehensive automated EDA analysis with visualizations and insights

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`autoedaBase` -\> `autoedaClass`

## Methods

### Public methods

- [`autoedaClass$clone()`](#method-autoedaClass-clone)
