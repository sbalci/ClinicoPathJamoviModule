...
An `R6` class generator object for the `decisioncombineClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`decisioncombineBase` -\> `decisioncombineClass`

## Methods

### Public methods

- [`decisioncombineClass$asSource()`](#method-decisioncombineClass-asSource)

- [`decisioncombineClass$clone()`](#method-decisioncombineClass-clone)
...
- `decisioncombineBase$initialize()`

------------------------------------------------------------------------

### `decisioncombineClass$asSource()`
...
### `decisioncombineClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    decisioncombineClass$clone(deep = FALSE)
