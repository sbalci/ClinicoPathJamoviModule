...
An `R6` class generator object for the `winratioClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`winratioBase` -\> `winratioClass`

## Methods

### Public methods

- [`winratioClass$clone()`](#method-winratioClass-clone)
...
#### Usage
    ...
    winratioClass$clone(deep = FALSE)
