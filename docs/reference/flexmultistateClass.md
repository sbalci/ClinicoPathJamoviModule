...
An `R6` class generator object for the `flexmultistateClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`flexmultistateBase` -\> `flexmultistateClass`

## Methods

### Public methods

- [`flexmultistateClass$clone()`](#method-flexmultistateClass-clone)
...
- `flexmultistateBase$initialize()`

------------------------------------------------------------------------

### `flexmultistateClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    flexmultistateClass$clone(deep = FALSE)
