# Aalen's Additive Hazard Models Implementation

Backend implementation class for Aalen's additive hazard regression
models. This R6 class provides comprehensive functionality for
non-proportional hazards modeling using additive covariate effects,
...
`aalenhazardBase` -\> `aalenhazardClass`

## Methods

### Public methods

- [`aalenhazardClass$clone()`](#method-aalenhazardClass-clone)
...
- `aalenhazardBase$initialize()`

------------------------------------------------------------------------

### `aalenhazardClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    aalenhazardClass$clone(deep = FALSE)
