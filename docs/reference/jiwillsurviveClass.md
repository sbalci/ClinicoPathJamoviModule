...
An `R6` class generator object for the `jiwillsurviveClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jiwillsurviveBase` -\> `jiwillsurviveClass`

## Methods

### Public methods

- [`jiwillsurviveClass$clone()`](#method-jiwillsurviveClass-clone)
...
- `jiwillsurviveBase$initialize()`

------------------------------------------------------------------------

### `jiwillsurviveClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    jiwillsurviveClass$clone(deep = FALSE)
