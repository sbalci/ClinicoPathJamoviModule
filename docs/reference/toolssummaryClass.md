...
`toolssummaryBase` -\> `toolssummaryClass`

## Methods

### Public methods

- [`toolssummaryClass$clone()`](#method-toolssummaryClass-clone)
...
- `toolssummaryBase$initialize()`

------------------------------------------------------------------------

### `toolssummaryClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    toolssummaryClass$clone(deep = FALSE)
