...
An `R6` class generator object for the `smoothhazardClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`smoothhazardBase` -\> `smoothhazardClass`

## Methods

### Public methods

- [`smoothhazardClass$clone()`](#method-smoothhazardClass-clone)
...
- `smoothhazardBase$initialize()`

------------------------------------------------------------------------

### `smoothhazardClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    smoothhazardClass$clone(deep = FALSE)
