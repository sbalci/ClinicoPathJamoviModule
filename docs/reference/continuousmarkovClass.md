...
An `R6` class generator object for the `continuousmarkovClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`continuousmarkovBase` -\> `continuousmarkovClass`

## Methods

### Public methods

- [`continuousmarkovClass$clone()`](#method-continuousmarkovClass-clone)
...
- `continuousmarkovBase$initialize()`

------------------------------------------------------------------------

### `continuousmarkovClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    continuousmarkovClass$clone(deep = FALSE)
