...
Implements the four Magee Equations from Klein et al. (2013, PMID:
23503643) for estimating Oncotype DX Recurrence Score from standard
...
`mageeequationBase` -\> `mageeequationClass`

## Methods

### Public methods

- [`mageeequationClass$clone()`](#method-mageeequationClass-clone)
...
- `mageeequationBase$initialize()`

------------------------------------------------------------------------

### `mageeequationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    mageeequationClass$clone(deep = FALSE)
