...
An `R6` class generator object for the `coxphwClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`coxphwBase` -\> `coxphwClass`

## Methods

### Public methods

- [`coxphwClass$clone()`](#method-coxphwClass-clone)
