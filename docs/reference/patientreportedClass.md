...
An `R6` class generator object for the `patientreportedClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`patientreportedBase` -\> `patientreportedClass`

## Methods

### Public methods

- [`patientreportedClass$clone()`](#method-patientreportedClass-clone)
...
- `patientreportedBase$initialize()`

------------------------------------------------------------------------

### `patientreportedClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    patientreportedClass$clone(deep = FALSE)
