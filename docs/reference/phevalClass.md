...
An `R6` class generator object for the `phevalClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`phevalBase` -\> `phevalClass`

## Methods

### Public methods

- [`phevalClass$clone()`](#method-phevalClass-clone)
