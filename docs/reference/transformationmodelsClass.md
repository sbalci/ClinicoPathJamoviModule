...
An `R6` class generator object for the `transformationmodelsClass`
...
`transformationmodelsBase` -\> `transformationmodelsClass`

## Methods

### Public methods

- [`transformationmodelsClass$clone()`](#method-transformationmodelsClass-clone)
...
- `transformationmodelsBase$initialize()`

------------------------------------------------------------------------

### `transformationmodelsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    transformationmodelsClass$clone(deep = FALSE)
