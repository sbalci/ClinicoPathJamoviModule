...
An `R6` class generator object for the `enhancedtwowayfrequencyClass`
...
`enhancedtwowayfrequencyBase` -\> `enhancedtwowayfrequencyClass`

## Methods

### Public methods

- [`enhancedtwowayfrequencyClass$clone()`](#method-enhancedtwowayfrequencyClass-clone)
...
- `enhancedtwowayfrequencyBase$initialize()`

------------------------------------------------------------------------

### `enhancedtwowayfrequencyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    enhancedtwowayfrequencyClass$clone(deep = FALSE)
