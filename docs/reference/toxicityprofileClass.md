...
`toxicityprofileBase` -\> `toxicityprofileClass`

## Methods

### Public methods

- [`toxicityprofileClass$clone()`](#method-toxicityprofileClass-clone)
...
- `toxicityprofileBase$initialize()`

------------------------------------------------------------------------

### `toxicityprofileClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    toxicityprofileClass$clone(deep = FALSE)
