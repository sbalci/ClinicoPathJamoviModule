...
An `R6` class generator object for the `enhancedfactorvariableClass`
...
`enhancedfactorvariableBase` -\> `enhancedfactorvariableClass`

## Methods

### Public methods

- [`enhancedfactorvariableClass$clone()`](#method-enhancedfactorvariableClass-clone)
...
- `enhancedfactorvariableBase$initialize()`

------------------------------------------------------------------------

### `enhancedfactorvariableClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    enhancedfactorvariableClass$clone(deep = FALSE)
