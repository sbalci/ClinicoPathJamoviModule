...
An `R6` class generator object for the `enhancedfrequencyClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`enhancedfrequencyBase` -\> `enhancedfrequencyClass`

## Methods

### Public methods

- [`enhancedfrequencyClass$clone()`](#method-enhancedfrequencyClass-clone)
...
- `enhancedfrequencyBase$initialize()`

------------------------------------------------------------------------

### `enhancedfrequencyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    enhancedfrequencyClass$clone(deep = FALSE)
