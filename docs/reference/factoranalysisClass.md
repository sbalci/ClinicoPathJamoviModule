...
Comprehensive factor analysis implementation inspired by BlueSky's
...
`factoranalysisBase` -\> `factoranalysisClass`

## Methods

### Public methods

- [`factoranalysisClass$clone()`](#method-factoranalysisClass-clone)
...
- `factoranalysisBase$initialize()`

------------------------------------------------------------------------

### `factoranalysisClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    factoranalysisClass$clone(deep = FALSE)
