...
An `R6` class generator object for the `frailtysurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`frailtysurvivalBase` -\> `frailtysurvivalClass`

## Methods

### Public methods

- [`frailtysurvivalClass$clone()`](#method-frailtysurvivalClass-clone)
...
- `frailtysurvivalBase$initialize()`

------------------------------------------------------------------------

### `frailtysurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    frailtysurvivalClass$clone(deep = FALSE)
