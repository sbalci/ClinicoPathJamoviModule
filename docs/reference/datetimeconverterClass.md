...
`datetimeconverterBase` -\> `datetimeconverterClass`

## Methods

### Public methods

- [`datetimeconverterClass$clone()`](#method-datetimeconverterClass-clone)
...
- `datetimeconverterBase$initialize()`

------------------------------------------------------------------------

### `datetimeconverterClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    datetimeconverterClass$clone(deep = FALSE)
