...
An `R6` class generator object for the `kappaSizeFixedNClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`kappaSizeFixedNBase` -\> `kappaSizeFixedNClass`

## Methods

### Public methods

- [`kappaSizeFixedNClass$clone()`](#method-kappaSizeFixedNClass-clone)
...
- `kappaSizeFixedNBase$initialize()`

------------------------------------------------------------------------

### `kappaSizeFixedNClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    kappaSizeFixedNClass$clone(deep = FALSE)
