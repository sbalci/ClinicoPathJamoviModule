...
`joinpointBase` -\> `joinpointClass`

## Methods

### Public methods

- [`joinpointClass$clone()`](#method-joinpointClass-clone)
...
- `joinpointBase$initialize()`

------------------------------------------------------------------------

### `joinpointClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    joinpointClass$clone(deep = FALSE)
