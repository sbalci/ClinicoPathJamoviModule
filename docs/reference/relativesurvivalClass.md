...
An `R6` class generator object for the `relativesurvivalClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`relativesurvivalBase` -\> `relativesurvivalClass`

## Methods

### Public methods

- [`relativesurvivalClass$clone()`](#method-relativesurvivalClass-clone)
...
- `relativesurvivalBase$initialize()`

------------------------------------------------------------------------

### `relativesurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    relativesurvivalClass$clone(deep = FALSE)
