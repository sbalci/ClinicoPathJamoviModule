...
An `R6` class generator object for the `ordinalmixedmodelClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`ordinalmixedmodelBase` -\> `ordinalmixedmodelClass`

## Methods

### Public methods

- [`ordinalmixedmodelClass$clone()`](#method-ordinalmixedmodelClass-clone)
...
- `ordinalmixedmodelBase$initialize()`

------------------------------------------------------------------------

### `ordinalmixedmodelClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    ordinalmixedmodelClass$clone(deep = FALSE)
