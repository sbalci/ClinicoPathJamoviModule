...
An `R6` class generator object for the `coxrobustClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`coxrobustBase` -\> `coxrobustClass`

## Methods

### Public methods

- [`coxrobustClass$clone()`](#method-coxrobustClass-clone)
...
- `coxrobustBase$initialize()`

------------------------------------------------------------------------

### `coxrobustClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    coxrobustClass$clone(deep = FALSE)
