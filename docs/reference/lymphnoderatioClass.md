...
`lymphnoderatioBase` -\> `lymphnoderatioClass`

## Methods

### Public methods

- [`lymphnoderatioClass$clone()`](#method-lymphnoderatioClass-clone)
...
- `lymphnoderatioBase$initialize()`

------------------------------------------------------------------------

### `lymphnoderatioClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    lymphnoderatioClass$clone(deep = FALSE)
