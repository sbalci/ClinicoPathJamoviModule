...
`hematologicindicesBase` -\> `hematologicindicesClass`

## Methods

### Public methods

- [`hematologicindicesClass$clone()`](#method-hematologicindicesClass-clone)
...
- `hematologicindicesBase$initialize()`

------------------------------------------------------------------------

### `hematologicindicesClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    hematologicindicesClass$clone(deep = FALSE)
