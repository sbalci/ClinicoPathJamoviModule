...
An `R6` class generator object for the `treecompareClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`treecompareBase` -\> `treecompareClass`

## Methods

### Public methods

- [`treecompareClass$clone()`](#method-treecompareClass-clone)
...
- `treecompareBase$initialize()`

------------------------------------------------------------------------

### `treecompareClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treecompareClass$clone(deep = FALSE)
