...
Modern, publication-ready tables using tinytable package

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`tinytableBase` -\> `tinytableClass`

## Methods

### Public methods

- [`tinytableClass$clone()`](#method-tinytableClass-clone)
...
- `tinytableBase$initialize()`

------------------------------------------------------------------------

### `tinytableClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    tinytableClass$clone(deep = FALSE)
