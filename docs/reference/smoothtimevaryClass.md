# Smoothly Time-Varying Effects Implementation

Backend implementation class for smooth estimation of time-varying
covariate effects. This R6 class provides comprehensive functionality
for continuous modeling of how covariate effects change over time using
flexible spline-based methods, kernel smoothing, and LOESS approaches,
...
`smoothtimevaryBase` -\> `smoothtimevaryClass`

## Methods

### Public methods

- [`smoothtimevaryClass$clone()`](#method-smoothtimevaryClass-clone)
...
- `smoothtimevaryBase$initialize()`

------------------------------------------------------------------------

### `smoothtimevaryClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    smoothtimevaryClass$clone(deep = FALSE)
