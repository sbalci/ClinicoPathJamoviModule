...
`biomarkerresponseBase` -\> `biomarkerresponseClass`

## Methods

### Public methods

- [`biomarkerresponseClass$asSource()`](#method-biomarkerresponseClass-asSource)

- [`biomarkerresponseClass$clone()`](#method-biomarkerresponseClass-clone)
...
- `biomarkerresponseBase$initialize()`

------------------------------------------------------------------------

### `biomarkerresponseClass$asSource()`
...
### `biomarkerresponseClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    biomarkerresponseClass$clone(deep = FALSE)
