...
Simple decision tree analysis optimized for clinical research

## Value

An `R6` class generator object for the `treemedicalClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`treemedicalBase` -\> `treemedicalClass`

## Methods

### Public methods

- [`treemedicalClass$clone()`](#method-treemedicalClass-clone)
...
- `treemedicalBase$initialize()`

------------------------------------------------------------------------

### `treemedicalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treemedicalClass$clone(deep = FALSE)
