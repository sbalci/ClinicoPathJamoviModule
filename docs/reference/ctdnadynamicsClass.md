...
`ctdnadynamicsBase` -\> `ctdnadynamicsClass`

## Methods

### Public methods

- [`ctdnadynamicsClass$clone()`](#method-ctdnadynamicsClass-clone)
...
- `ctdnadynamicsBase$initialize()`

------------------------------------------------------------------------

### `ctdnadynamicsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    ctdnadynamicsClass$clone(deep = FALSE)
