...
Pathology interrater reliability analysis including Cohen's kappa,
...
`pathagreementBase` -\> `pathagreementClass`

## Methods

### Public methods

- [`pathagreementClass$asSource()`](#method-pathagreementClass-asSource)

- [`pathagreementClass$clone()`](#method-pathagreementClass-clone)
...
- `pathagreementBase$initialize()`

------------------------------------------------------------------------

### `pathagreementClass$asSource()`
...
### `pathagreementClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pathagreementClass$clone(deep = FALSE)
