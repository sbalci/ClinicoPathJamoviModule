# Royston-Parmar Flexible Parametric Models Implementation

Backend implementation class for Royston-Parmar flexible parametric
survival models. This R6 class provides comprehensive functionality for
flexible parametric modeling using restricted cubic splines to model the
...
`flexrstpm2Base` -\> `flexrstpm2Class`

## Methods

### Public methods

- [`flexrstpm2Class$clone()`](#method-flexrstpm2Class-clone)
...
- `flexrstpm2Base$initialize()`

------------------------------------------------------------------------

### `flexrstpm2Class$clone()`

The objects of this class are cloneable with this method.

#### Usage

    flexrstpm2Class$clone(deep = FALSE)
