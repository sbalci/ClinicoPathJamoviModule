...
Hull plot using ggforce for cluster and group visualization

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`hullplotBase` -\> `hullplotClass`

## Methods

### Public methods

- [`hullplotClass$clone()`](#method-hullplotClass-clone)
...
#### Usage
    ...
    hullplotClass$clone(deep = FALSE)
