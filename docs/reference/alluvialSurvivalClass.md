...
Generates an alluvial plot to visualize patient treatment pathways over
time with optional survival analysis.
...
`alluvialSurvivalBase` -\> `alluvialSurvivalClass`

## Methods

### Public methods

- [`alluvialSurvivalClass$clone()`](#method-alluvialSurvivalClass-clone)
...
- `alluvialSurvivalBase$initialize()`

------------------------------------------------------------------------

### `alluvialSurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    alluvialSurvivalClass$clone(deep = FALSE)
