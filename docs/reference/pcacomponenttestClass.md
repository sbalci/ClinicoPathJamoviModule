...
An `R6` class generator object for the `pcacomponenttestClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`pcacomponenttestBase` -\> `pcacomponenttestClass`

## Methods

### Public methods

- [`pcacomponenttestClass$clone()`](#method-pcacomponenttestClass-clone)
...
- `pcacomponenttestBase$initialize()`

------------------------------------------------------------------------

### `pcacomponenttestClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    pcacomponenttestClass$clone(deep = FALSE)
