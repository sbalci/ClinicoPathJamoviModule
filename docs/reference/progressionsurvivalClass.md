...
An `R6` class generator object for the `progressionsurvivalClass`
...
`progressionsurvivalBase` -\> `progressionsurvivalClass`

## Methods

### Public methods

- [`progressionsurvivalClass$clone()`](#method-progressionsurvivalClass-clone)
...
- `progressionsurvivalBase$initialize()`

------------------------------------------------------------------------

### `progressionsurvivalClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    progressionsurvivalClass$clone(deep = FALSE)
