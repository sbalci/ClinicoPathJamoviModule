...
An `R6` class generator object for the `ggprismClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`ggprismBase` -\> `ggprismClass`

## Methods

### Public methods

- [`ggprismClass$clone()`](#method-ggprismClass-clone)
