...
An `R6` class generator object for the `enhancedtablesClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`enhancedtablesBase` -\> `enhancedtablesClass`

## Methods

### Public methods

- [`enhancedtablesClass$clone()`](#method-enhancedtablesClass-clone)
...
- `enhancedtablesBase$initialize()`

------------------------------------------------------------------------

### `enhancedtablesClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    enhancedtablesClass$clone(deep = FALSE)
