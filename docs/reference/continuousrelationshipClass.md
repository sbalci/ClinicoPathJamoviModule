...
Analyzes relationships between continuous variables using evidence-based
approaches from BMJ best practices. Implements splines, fractional
...
`continuousrelationshipBase` -\> `continuousrelationshipClass`

## Methods

### Public methods

- [`continuousrelationshipClass$clone()`](#method-continuousrelationshipClass-clone)
...
- `continuousrelationshipBase$initialize()`

------------------------------------------------------------------------

### `continuousrelationshipClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    continuousrelationshipClass$clone(deep = FALSE)
