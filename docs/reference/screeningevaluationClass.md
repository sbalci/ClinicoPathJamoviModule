...
`screeningevaluationBase` -\> `screeningevaluationClass`

## Methods

### Public methods

- [`screeningevaluationClass$clone()`](#method-screeningevaluationClass-clone)
...
- `screeningevaluationBase$initialize()`

------------------------------------------------------------------------

### `screeningevaluationClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    screeningevaluationClass$clone(deep = FALSE)
