...
An `R6` class generator object for the `curemodelsClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`curemodelsBase` -\> `curemodelsClass`

## Methods

### Public methods

- [`curemodelsClass$clone()`](#method-curemodelsClass-clone)
...
- `curemodelsBase$initialize()`

------------------------------------------------------------------------

### `curemodelsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    curemodelsClass$clone(deep = FALSE)
