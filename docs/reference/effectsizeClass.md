...
An `R6` class generator object for the `effectsizeClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`effectsizeBase` -\> `effectsizeClass`

## Methods

### Public methods

- [`effectsizeClass$clone()`](#method-effectsizeClass-clone)
...
- `effectsizeBase$initialize()`

------------------------------------------------------------------------

### `effectsizeClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    effectsizeClass$clone(deep = FALSE)
