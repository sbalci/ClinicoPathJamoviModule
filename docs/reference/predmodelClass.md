...
An `R6` class generator object for the `predmodelClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`predmodelBase` -\> `predmodelClass`

## Methods

### Public methods

- [`predmodelClass$clone()`](#method-predmodelClass-clone)
...
- `predmodelBase$initialize()`

------------------------------------------------------------------------

### `predmodelClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    predmodelClass$clone(deep = FALSE)
