...
R6 class for performing causal treatment effects analysis.

## Value

An `R6` class generator object for the `treatmenteffectsClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`treatmenteffectsBase` -\> `treatmenteffectsClass`

## Methods

### Public methods

- [`treatmenteffectsClass$clone()`](#method-treatmenteffectsClass-clone)
...
- `treatmenteffectsBase$initialize()`

------------------------------------------------------------------------

### `treatmenteffectsClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    treatmenteffectsClass$clone(deep = FALSE)
