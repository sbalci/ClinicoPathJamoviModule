...
R6 class for performing treatment response analysis using waterfall
plots.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`waterfallBase` -\> `waterfallClass`

## Methods

### Public methods

- [`waterfallClass$asSource()`](#method-waterfallClass-asSource)

- [`waterfallClass$clone()`](#method-waterfallClass-clone)
...
- `waterfallBase$initialize()`

------------------------------------------------------------------------

### `waterfallClass$asSource()`
