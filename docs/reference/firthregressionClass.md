...
An `R6` class generator object for the `firthregressionClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`firthregressionBase` -\> `firthregressionClass`

## Methods

### Public methods

- [`firthregressionClass$clone()`](#method-firthregressionClass-clone)
...
- `firthregressionBase$initialize()`

------------------------------------------------------------------------

### `firthregressionClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    firthregressionClass$clone(deep = FALSE)
