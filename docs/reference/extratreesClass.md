...
An `R6` class generator object for the `extratreesClass` backend; used
internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`extratreesBase` -\> `extratreesClass`

## Methods

### Public methods

- [`extratreesClass$clone()`](#method-extratreesClass-clone)
...
- `extratreesBase$initialize()`

------------------------------------------------------------------------

### `extratreesClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    extratreesClass$clone(deep = FALSE)
