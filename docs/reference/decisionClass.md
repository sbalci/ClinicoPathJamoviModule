...
with options for various visualization methods and statistical
comparisons.
...
`decisionBase` -\> `decisionClass`

## Methods

### Public methods

- [`decisionClass$clone()`](#method-decisionClass-clone)
