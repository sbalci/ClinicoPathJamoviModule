...
`emfrailtyBase` -\> `emfrailtyClass`

## Methods

### Public methods

- [`emfrailtyClass$clone()`](#method-emfrailtyClass-clone)
...
- `emfrailtyBase$initialize()`

------------------------------------------------------------------------

### `emfrailtyClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    emfrailtyClass$clone(deep = FALSE)
