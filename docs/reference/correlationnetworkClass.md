...
`ClinicoPath::correlationnetworkBase` -\> `correlationnetworkClass`

## Methods

### Public methods

- [`correlationnetworkClass$clone()`](#method-correlationnetworkClass-clone)
...
- [`ClinicoPath::correlationnetworkBase$initialize()`](https://www.serdarbalci.com/ClinicoPathJamoviModule/reference/correlationnetworkBase.html#method-initialize)
...
#### Usage
    ...
    correlationnetworkClass$clone(deep = FALSE)
