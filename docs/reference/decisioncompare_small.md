...
#>  performance with 75% sensitivity (95% CI: [see confidence interval
#>  table]), 83.3% specificity (95% CI: [see confidence interval table]),
#>  75% positive predictive value, 83.3% negative predictive value, and
#>  80% overall accuracy. The likelihood ratio for positive results was
#>  4.50 and for negative results was 0.30.<h3 style="color: #27ae60;
...
#>  sensitivity (95% CI: [see confidence interval table]), 83.3%
#>  specificity (95% CI: [see confidence interval table]), 75% positive
#>  predictive value, 83.3% negative predictive value, and 80% overall
#>  accuracy. The likelihood ratio for positive results was 4.50 and for
#>  negative results was 0.30.
#> 
