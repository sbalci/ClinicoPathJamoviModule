...
time-dependent and general binary ROC analysis. Supports multiple ROC
...
- Time-dependent ROC: Cumulative/dynamic ROC with IPCW weighting options
...
`timerocBase` -\> `timerocClass`

## Methods

### Public methods

- [`timerocClass$clone()`](#method-timerocClass-clone)
