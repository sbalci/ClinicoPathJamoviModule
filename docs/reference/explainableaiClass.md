...
An `R6` class generator object for the `explainableaiClass` backend;
used internally by the jamovi analysis wrapper and not called directly.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`explainableaiBase` -\> `explainableaiClass`

## Methods

### Public methods

- [`explainableaiClass$clone()`](#method-explainableaiClass-clone)
...
- `explainableaiBase$initialize()`

------------------------------------------------------------------------

### `explainableaiClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    explainableaiClass$clone(deep = FALSE)
