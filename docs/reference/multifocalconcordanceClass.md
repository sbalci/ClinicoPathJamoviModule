...
`multifocalconcordanceBase` -\> `multifocalconcordanceClass`

## Methods

### Public methods

- [`multifocalconcordanceClass$clone()`](#method-multifocalconcordanceClass-clone)
...
- `multifocalconcordanceBase$initialize()`

------------------------------------------------------------------------

### `multifocalconcordanceClass$clone()`

The objects of this class are cloneable with this method.

#### Usage

    multifocalconcordanceClass$clone(deep = FALSE)
