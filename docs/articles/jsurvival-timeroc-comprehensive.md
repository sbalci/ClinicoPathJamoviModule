...
> **Not yet released.** The `timeroc` analysis is on a development menu
...
#>  ───────────────────────────────────────────────────────────────────────────── 
#>           12          42.50000      0.6570000      0.8120000       0.4690000   
#>           36          39.30000      0.5840000      0.8860000       0.4710000   
#>           60          39.60000      0.4690000      0.9750000       0.4440000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
...
#>  ───────────────────────────────────────────────────────────────────────────── 
#>           12          42.50000      0.6570000      0.8120000       0.4690000   
#>           36          37.70000      0.6050000      0.8700000       0.4760000   
#>           60          39.60000      0.4650000      0.9790000       0.4440000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
#>  Clinical Interpretation
...
#>    Timepoint    Optimal Cutoff    Sensitivity    Specificity    Youden Index   
#>  ───────────────────────────────────────────────────────────────────────────── 
#>           12          42.50000      0.6590000      0.8100000       0.4690000   
#>           36          37.70000      0.6080000      0.8730000       0.4820000   
#>           60          39.60000      0.4670000      0.9810000       0.4480000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
#>  Clinical Interpretation
...
#>  ───────────────────────────────────────────────────────────────────────────── 
#>           12          42.50000      0.6570000      0.8120000       0.4690000   
#>           24          39.50000      0.6670000      0.8400000       0.5070000   
#>           36          39.30000      0.5840000      0.8860000       0.4710000   
#>           48          39.30000      0.5360000      0.9320000       0.4680000   
#>           60          39.60000      0.4690000      0.9750000       0.4440000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
...
#>    Timepoint    Optimal Cutoff    Sensitivity    Specificity    Youden Index   
#>  ───────────────────────────────────────────────────────────────────────────── 
#>            6          31.10000      0.8230000      0.5700000       0.3930000   
#>           12          42.50000      0.6570000      0.8120000       0.4690000   
#>           18          42.50000      0.6670000      0.8460000       0.5130000   
#>           24          39.50000      0.6670000      0.8400000       0.5070000   
#>           36          39.30000      0.5840000      0.8860000       0.4710000   
#>           48          39.30000      0.5360000      0.9320000       0.4680000   
#>           60          39.60000      0.4690000      0.9750000       0.4440000   
...
#>    Timepoint    Optimal Cutoff    Sensitivity    Specificity    Youden Index   
#>  ───────────────────────────────────────────────────────────────────────────── 
#>           19          42.50000      0.6670000      0.8500000       0.5170000   
#>           33          37.70000      0.6100000      0.8630000       0.4730000   
#>           55          39.60000      0.5030000      0.9790000       0.4820000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
#> character(0)
...
#>    Timepoint    Optimal Cutoff    Sensitivity    Specificity    Youden Index   
#>  ───────────────────────────────────────────────────────────────────────────── 
#>            3          4.430000      1.0000000      0.4280000       0.4280000   
#>            6          4.300000      0.9410000      0.4030000       0.3440000   
#>            9          4.300000      0.9580000      0.4230000       0.3810000   
#>           12          5.270000      0.7710000      0.6500000       0.4210000   
#>           18          5.190000      0.7610000      0.6640000       0.4250000   
#>           24          4.430000      0.8770000      0.5670000       0.4440000   
#>           30          4.430000      0.8380000      0.6020000       0.4400000   
#>           36          4.430000      0.8130000      0.5980000       0.4110000   
#>           42          4.450000      0.8070000      0.6760000       0.4820000   
#>           48          4.450000      0.7920000      0.7300000       0.5220000   
#>           54          4.450000      0.7640000      0.7200000       0.4840000   
#>           60          4.450000      0.7350000      0.6900000       0.4250000   
#>  ───────────────────────────────────────────────────────────────────────────── 
#> 
#> 
#>  Clinical Interpretation
