...
- **[Tutorial Series Home](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/README.md)** - Complete learning paths for clinical trials, diagnostic pathology, and advanced analyses
- **Quick Start:** [Getting Started with ClinicoPath](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/01-getting-started.qmd) (30 min)
- **Clinical Trials:** [Table One for Baseline Characteristics](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/02-table-one-clinical-trial.qmd) (45 min)
- **Survival Analysis:** [Kaplan-Meier & Cox Regression](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/03-survival-analysis-cancer.qmd) (45 min)
- **Diagnostic Testing:** [ROC Analysis & Optimal Cutpoints](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/04-roc-diagnostic-test.qmd) (45 min)
- **Advanced Modeling:** [Decision Curve Analysis](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/05-decision-curve-analysis.qmd) (50 min)
- **Reproducibility:** [Automated Reports & Version Control](https://github.com/sbalci/ClinicoPathJamoviModule/blob/master/tutorials/06-reproducible-reports.qmd) (40 min)
...
- [ggstatsplot](https://www.indrapatil.com/ggstatsplot/) developer [Indrajeet Patil](https://github.com/IndrajeetPatil), 
...
<!-- badges: start -->
[![Launch Rstudio Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/sbalci/ClinicoPathJamoviModule/master?urlpath=rstudio)
