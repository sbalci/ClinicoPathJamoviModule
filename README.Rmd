...
*   **Survival Analysis:** Comprehensive survival analysis framework including Kaplan-Meier estimation, log-rank tests, Cox proportional hazards models, advanced pseudo-observation methods, restricted mean survival time (RMST) regression, dynamic survival prediction, conditional survival estimation, and high-dimensional survival analysis (PCA-Cox, PLS-Cox).
