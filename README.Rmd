...
*   **Agreement and Reliability:** Inter-rater reliability statistics (Cohen's Kappa, ICC) and method comparison (Bland-Altman, Deming Regression).
...
*   **Spatial Statistics & Digital Pathology:** Tools for spatial point pattern analysis (Ripley's K-function), spatial autocorrelation (Moran's I), and Haralick texture analysis.
