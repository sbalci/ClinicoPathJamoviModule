...
- This file lives in `.claude/commands/` and is executed via `/check-function-full <function_name>`.
- **Legacy alias:** `/check-function-base` still works but is deprecated.
